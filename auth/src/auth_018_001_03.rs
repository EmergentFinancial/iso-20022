...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.018.001.03".to_string()
}
...
> {
    ...
    pub ctrct_regn_req: ContractRegistrationRequestV03<A, B, C, D, E, F>,
...
> {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "CtrctRegnOpng", default)]
    pub ctrct_regn_opng: Vec<ContractRegistration6<A, B, C, D>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "PrvsRegnId", default)]
    pub prvs_regn_id: Vec<DocumentIdentification22>,
    #[serde(rename = "AddtlInf", skip_serializing_if = "Option::is_none")]
    pub addtl_inf: Option<Max1025Text>,
    #[validate(length(min = 0,))]
    #[serde(rename = "Attchmnt", default)]
    pub attchmnt: Vec<DocumentGeneralInformation5<C>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
...
> {
    ...
    pub trad: Option<TradeContract3<A>>,
    #[serde(rename = "Ln", skip_serializing_if = "Option::is_none")]
    pub ln: Option<LoanContract3<B>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "CtrctRegn", default)]
    pub ctrct_regn: Vec<ContractRegistration5<A, B, C, D, E>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
    pub splmtry_data: Vec<SupplementaryData1<F>>,
}
#[derive(
    Debug,
    Default,
