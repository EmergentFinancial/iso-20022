...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.019.001.03".to_string()
}
...
> {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "RegdCtrct", default)]
    pub regd_ctrct: Vec<RegisteredContract11<A, B, C>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub ctrct_regn_conf: ContractRegistrationConfirmationV03<A, B, C, D>,
