...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.053.001.01".to_string()
}
...
> {
    ...
    #[serde(rename = "VolCapRslt", default)]
...
pub struct VolumeCapResult1 {
    ...
    pub last_upd_dt: Option<IsoDate>,
    #[validate]
    ...
    pub tradg_udr_wvr_pctg: PercentageRate,
    #[validate(length(min = 0,))]
    #[serde(rename = "TradgUdrWvrBrkdwn", default)]
...
> {
    ...
    pub fin_instrm_rptg_tradg_vol_cap_rslt_rpt:
        FinancialInstrumentReportingTradingVolumeCapResultReportV01<A>,
