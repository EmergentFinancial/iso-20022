...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.049.001.02".to_string()
}
...
> {
    ...
    pub fin_instrm_rptg_mkt_id_cd_rpt:
        FinancialInstrumentReportingMarketIdentificationCodeReportV02<A>,
