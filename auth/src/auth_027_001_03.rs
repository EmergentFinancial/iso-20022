...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.027.001.03".to_string()
}
...
> {
    ...
    #[serde(rename = "GrpSts", default)]
    pub grp_sts: Vec<CurrencyControlGroupStatus2>,
    #[validate(length(min = 0,))]
    #[serde(rename = "PackgSts", default)]
...
pub struct CurrencyControlGroupStatus2 {
    ...
    pub sts_dt_tm: Option<IsoDateTime>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub ccy_ctrl_sts_advc: CurrencyControlStatusAdviceV03<A>,
