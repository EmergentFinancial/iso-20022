...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.038.001.01".to_string()
}
...
> {
    ...
    pub invc_tax_rpt_sts_advc: InvoiceTaxReportStatusAdviceV01<A, B>,
...
> {
    ...
    pub tx_sts: Vec<InvoiceTaxReportTransactionStatus1<A>>,
    #[validate(length(min = 0,))]
