...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.058.001.01".to_string()
}
...
> {
    ...
    #[serde(rename = "ScnroStrssTstRslt", default)]
...
pub struct ScenarioStressTestResult1 {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "PrtflStrssTstRslt", default)]
...
> {
    ...
    pub ccp_prtfl_strss_tstg_rslt_rpt: CcpPortfolioStressTestingResultReportV01<A>,
