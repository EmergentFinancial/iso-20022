...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.041.001.01".to_string()
}
...
pub struct TransparencyDataReport15 {
    ...
    pub nb_txs: Option<Number>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AggtdQttvData", default)]
...
> {
    ...
    pub fin_instrm_rptg_non_eqty_tradg_actvty_rpt:
        FinancialInstrumentReportingNonEquityTradingActivityReportV01<A>,
