...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.052.001.02".to_string()
}
...
pub struct TransactionLoanData30ChoiceEnum {
...
pub struct TransactionLoanData30Choice {
    #[serde(flatten)]
    pub value: TransactionLoanData30ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub trad_data: TradeData40Choice<A, B, C, D, E, F, G, H>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
...
pub struct TradeReport22ChoiceEnum<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    D: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    ...
    pub valtn_upd: Option<TradeValuationUpdate9<A>>,
    #[serde(rename = "Mod", skip_serializing_if = "Option::is_none")]
    pub r#mod: Option<TradeTransactionCorrection13<B>>,
    #[serde(rename = "EarlyTermntn", skip_serializing_if = "Option::is_none")]
    pub early_termntn: Option<TradeError9<C>>,
    #[serde(rename = "PosCmpnt", skip_serializing_if = "Option::is_none")]
    pub pos_cmpnt: Option<TradeTransactionPositionComponent8<D>>,
    #[serde(rename = "Crrctn", skip_serializing_if = "Option::is_none")]
    pub crrctn: Option<TradeTransactionCorrection13<E>>,
    #[serde(rename = "Err", skip_serializing_if = "Option::is_none")]
    pub err: Option<TradeError9<F>>,
    #[serde(rename = "CollUpd", skip_serializing_if = "Option::is_none")]
    pub coll_upd: Option<TradeTransactionCollateralUpdate8<G>>,
    #[serde(rename = "New", skip_serializing_if = "Option::is_none")]
    pub new: Option<TradeNewTransaction13<H>>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[serde(flatten)]
    pub value: TradeReport22ChoiceEnum<A, B, C, D, E, F, G, H>,
}
#[derive(
    Debug,
    Default,
...
pub struct TransactionLoanData26ChoiceEnum {
    #[serde(rename = "BuySellBck", skip_serializing_if = "Option::is_none")]
...
pub struct TransactionLoanData26Choice {
    #[serde(flatten)]
    pub value: TransactionLoanData26ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
> {
    ...
    pub scties_fincg_rptg_tx_rpt:
        SecuritiesFinancingReportingTransactionReportV02<A, B, C, D, E, F, G, H, I>,
...
pub struct TradeData40ChoiceEnum<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    D: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    ...
    pub rpt: Option<TradeReport22Choice<A, B, C, D, E, F, G, H>>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[serde(flatten)]
    pub value: TradeData40ChoiceEnum<A, B, C, D, E, F, G, H>,
}
#[derive(
    Debug,
    Default,
...
pub struct TransactionLoanData32ChoiceEnum {
    #[serde(rename = "BuySellBck", skip_serializing_if = "Option::is_none")]
...
pub struct TransactionLoanData32Choice {
    #[serde(flatten)]
    pub value: TransactionLoanData32ChoiceEnum,
}
#[derive(
    Debug,
    Default,
