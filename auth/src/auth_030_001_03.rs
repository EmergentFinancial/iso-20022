...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.030.001.03".to_string()
}
...
pub struct TradeReport32ChoiceEnum<
...
pub struct TradeReport32Choice<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    D: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    #[serde(flatten)]
    pub value: TradeReport32ChoiceEnum<A, B, C, D, E, F, G, H, I, J, K>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub cmon_trad_data: CommonTradeDataReport69,
...
pub struct TradeData57ChoiceEnum<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    D: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    ...
    pub rpt: Option<TradeReport32Choice<A, B, C, D, E, F, G, H, I, J, K>>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[serde(flatten)]
    pub value: TradeData57ChoiceEnum<A, B, C, D, E, F, G, H, I, J, K>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub derivs_trad_rpt: DerivativesTradeReportV03<A, B, C, D, E, F, G, H, I, J, K, L>,
...
pub struct CommonTradeDataReport69 {
...
pub struct DerivativesTradeReportV03<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    D: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    ...
    pub trad_data: TradeData57Choice<A, B, C, D, E, F, G, H, I, J, K>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
    pub splmtry_data: Vec<SupplementaryData1<L>>,
}
#[derive(
    Debug,
    Default,
