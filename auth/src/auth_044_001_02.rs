...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.044.001.02".to_string()
}
...
pub struct MarketDetail2 {
    ...
    pub avrg_daly_nb_of_txs: Option<DecimalNumber>,
}
#[derive(
    Debug,
    Default,
...
pub struct TransparencyDataReport17 {
    ...
    pub lqdty: Option<TrueFalseIndicator>,
...
> {
    ...
    pub fin_instrm_rptg_eqty_tradg_actvty_rslt:
        FinancialInstrumentReportingEquityTradingActivityResultV02<A>,
