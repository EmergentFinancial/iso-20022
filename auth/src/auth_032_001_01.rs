...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.032.001.01".to_string()
}
...
> {
    ...
    pub fin_instrm_rptg_eqty_trnsprncy_data_rpt:
        FinancialInstrumentReportingEquityTransparencyDataReportV01<A>,
...
pub struct TransparencyDataReport11 {
    ...
    #[serde(rename = "NbOutsdngInstrms", skip_serializing_if = "Option::is_none")]
    pub nb_outsdng_instrms: Option<DecimalNumberFraction5>,
    #[serde(
        rename = "HldgsExcdgTtlVtngRghtThrshld",
        skip_serializing_if = "Option::is_none"
    )]
    pub hldgs_excdg_ttl_vtng_rght_thrshld: Option<DecimalNumberFraction5>,
    #[serde(rename = "IssncSz", skip_serializing_if = "Option::is_none")]
    pub issnc_sz: Option<ActiveCurrencyAndAmount>,
    #[serde(rename = "InstrmPric", skip_serializing_if = "Option::is_none")]
...
> {
    ...
    #[serde(rename = "EqtyTrnsprncyData", default)]
