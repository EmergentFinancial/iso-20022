...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.014.001.02".to_string()
}
...
> {
    ...
    pub fx_swps_rpt: ForeignExchangeSwap3Choice<A>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
...
> {
    ...
    pub mny_mkt_fx_swps_sttstcl_rpt: MoneyMarketForeignExchangeSwapsStatisticalReportV02<A, B>,
...
> {
    #[serde(flatten)]
    pub value: ForeignExchangeSwap3ChoiceEnum<A>,
}
