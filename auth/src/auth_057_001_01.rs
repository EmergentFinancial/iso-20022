...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.057.001.01".to_string()
}
...
> {
    ...
    pub ccp_prtfl_strss_tstg_def_rpt: CcpPortfolioStressTestingDefinitionReportV01<A>,
...
pub struct StressSize1ChoiceEnum {
...
pub struct StressSize1Choice {
    #[serde(flatten)]
    pub value: StressSize1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct StressItem1ChoiceEnum {
...
pub struct StressItem1Choice {
    #[serde(flatten)]
    pub value: StressItem1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
