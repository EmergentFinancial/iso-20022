...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.020.001.03".to_string()
}
...
> {
    ...
    pub ctrct_regn_clsr_req: ContractRegistrationClosureRequestV03<A, B, C>,
...
> {
    ...
    #[serde(rename = "RegdCtrctClsr", default)]
    pub regd_ctrct_clsr: Vec<RegisteredContract15<A, B>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub cssn: Option<ContractCessionData1>,
    #[validate(length(min = 0,))]
