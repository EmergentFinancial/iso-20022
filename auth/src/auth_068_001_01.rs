...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.068.001.01".to_string()
}
...
> {
    ...
    pub ccp_acct_pos_rpt: CcpAccountPositionReportV01<A>,
...
pub struct Position1 {
    ...
    pub grss_dlta_eqvt_qty: Option<NonNegativeFraction5DecimalNumber>,
    #[serde(rename = "NetDltaEqvtQty", skip_serializing_if = "Option::is_none")]
    pub net_dlta_eqvt_qty: Option<Fraction5DecimalNumber>,
    #[validate]
