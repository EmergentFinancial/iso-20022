...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:auth.047.001.01".to_string()
}
...
> {
    ...
    pub fin_instrm_rptg_ctry_cd_rpt: FinancialInstrumentReportingCountryCodeReportV01<A>,
