...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cafm.002.001.02".to_string()
}
...
pub struct FileActionResponse2<
...
> {
    ...
    #[validate]
    #[serde(rename = "Tx")]
    pub tx: Transaction158,
    #[validate]
    #[serde(rename = "PrcgRslt")]
    pub prcg_rslt: ResultData9,
    #[validate(length(min = 0,))]
...
pub struct FileActionResponseV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: FileActionResponse2<A>,
...
> {
    #[validate]
    #[serde(rename = "FileActnRspn")]
    pub file_actn_rspn: FileActionResponseV02<A>,
