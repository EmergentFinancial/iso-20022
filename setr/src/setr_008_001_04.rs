...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.008.001.04".to_string()
}
...
pub struct SubscriptionBulkOrderCancellationRequestV04 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    pub ordr_refs: Vec<InvestmentFundOrder9>,
...
pub struct InvestmentFundOrder9 {
    #[validate]
    ...
    pub cxl_rsn: Option<CancellationReason32Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct CancellationReason32ChoiceEnum {
...
pub struct CancellationReason32Choice {
    #[serde(flatten)]
    pub value: CancellationReason32ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[validate]
    #[serde(rename = "SbcptBlkOrdrCxlReq")]
    pub sbcpt_blk_ordr_cxl_req: SubscriptionBulkOrderCancellationRequestV04,
