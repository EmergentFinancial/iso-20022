...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.003.001.04".to_string()
}
...
pub struct Document {
    #[validate]
    #[serde(rename = "RedBlkOrdrConf")]
    pub red_blk_ordr_conf: RedemptionBulkOrderConfirmationV04,
...
pub struct RedemptionBulkOrderConfirmationV04 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    pub blk_exctn_dtls: RedemptionBulkExecution5,
...
pub struct RedemptionExecution16 {
    #[validate]
...
pub struct RedemptionBulkExecution5 {
    ...
    pub indv_exctn_dtls: Vec<RedemptionExecution16>,
