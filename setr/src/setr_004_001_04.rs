...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.004.001.04".to_string()
}
...
pub struct FinancialInstrumentQuantity28ChoiceEnum {
...
pub struct FinancialInstrumentQuantity28Choice {
    #[serde(flatten)]
    pub value: FinancialInstrumentQuantity28ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct RedemptionOrder14 {
    ...
    #[serde(rename = "SubAcctForHldg", skip_serializing_if = "Option::is_none")]
    pub sub_acct_for_hldg: Option<SubAccount6>,
    #[serde(rename = "AmtOrUnitsOrPctg")]
    pub amt_or_units_or_pctg: FinancialInstrumentQuantity28Choice,
    ...
    pub csh_sttlm_dtls: Option<PaymentTransaction72>,
...
pub struct PaymentTransaction72 {
    #[serde(rename = "PmtInstrm")]
    pub pmt_instrm: PaymentInstrument21Choice,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct RedemptionMultipleOrder6 {
    ...
    #[serde(rename = "IndvOrdrDtls", default)]
    pub indv_ordr_dtls: Vec<RedemptionOrder14>,
    #[serde(rename = "BlkCshSttlmDtls", skip_serializing_if = "Option::is_none")]
    pub blk_csh_sttlm_dtls: Option<PaymentTransaction72>,
...
pub struct Document {
    #[validate]
    #[serde(rename = "RedOrdr")]
    pub red_ordr: RedemptionOrderV04,
...
pub struct RedemptionOrderV04 {
    ...
    #[validate]
    #[serde(rename = "MltplOrdrDtls")]
    pub mltpl_ordr_dtls: RedemptionMultipleOrder6,
