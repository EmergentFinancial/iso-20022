...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.001.001.04".to_string()
}
...
pub struct RedemptionBulkOrderV04 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    #[validate]
    #[serde(rename = "BlkOrdrDtls")]
    pub blk_ordr_dtls: RedemptionBulkOrder6,
...
pub struct RedemptionBulkOrder6 {
    ...
    pub indv_ordr_dtls: Vec<RedemptionOrder15>,
...
pub struct Document {
    #[validate]
    #[serde(rename = "RedBlkOrdr")]
    pub red_blk_ordr: RedemptionBulkOrderV04,
