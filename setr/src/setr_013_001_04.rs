...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.013.001.04".to_string()
}
...
pub struct Document {
    #[validate]
    #[serde(rename = "SwtchOrdr")]
    pub swtch_ordr: SwitchOrderV04,
...
pub struct SwitchOrderV04 {
    ...
    #[serde(rename = "SwtchOrdrDtls", default)]
    pub swtch_ordr_dtls: Vec<SwitchOrder7>,
...
pub struct FeeAndTax1 {
    ...
    pub indv_fee: Vec<Fee1>,
    #[validate(length(min = 0,))]
    #[serde(rename = "IndvTax", default)]
    pub indv_tax: Vec<Tax30>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct CashInOrOut7ChoiceEnum {
    #[serde(rename = "CshOutPmtInstrm", skip_serializing_if = "Option::is_none")]
    pub csh_out_pmt_instrm: Option<PaymentInstrument21Choice>,
    #[serde(rename = "CshInPmtInstrm", skip_serializing_if = "Option::is_none")]
    pub csh_in_pmt_instrm: Option<PaymentInstrument20Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct CashInOrOut7Choice {
    #[serde(flatten)]
    pub value: CashInOrOut7ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct Fee1 {
    ...
    pub reqd_amt: Option<ActiveCurrencyAndAmount>,
    #[serde(rename = "ReqdRate", skip_serializing_if = "Option::is_none")]
    pub reqd_rate: Option<PercentageRate>,
...
pub struct FinancialInstrumentQuantity26ChoiceEnum {
    ...
    #[serde(rename = "PctgOfTtlRedAmt", skip_serializing_if = "Option::is_none")]
...
pub struct FinancialInstrumentQuantity26Choice {
    #[serde(flatten)]
    pub value: FinancialInstrumentQuantity26ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ForeignExchangeTerms32 {
...
pub struct Tax30 {
    ...
    pub tax: Option<TaxAmountOrRate4Choice>,
    ...
    pub tax_clctn_dtls: Option<TaxCalculationInformation9>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct SwitchSubscriptionLegOrder6 {
    ...
    #[serde(rename = "FinInstrmQtyChc", skip_serializing_if = "Option::is_none")]
    pub fin_instrm_qty_chc: Option<FinancialInstrumentQuantity26Choice>,
...
pub struct TaxAmountOrRate4ChoiceEnum {
    #[serde(rename = "Rate", skip_serializing_if = "Option::is_none")]
    pub rate: Option<PercentageRate>,
    #[serde(rename = "Amt", skip_serializing_if = "Option::is_none")]
...
pub struct TaxAmountOrRate4Choice {
    #[serde(flatten)]
    pub value: TaxAmountOrRate4ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct FinancialInstrumentQuantity29ChoiceEnum {
    #[serde(rename = "GrssAmt", skip_serializing_if = "Option::is_none")]
    pub grss_amt: Option<ActiveOrHistoricCurrencyAndAmount>,
    ...
    #[serde(rename = "UnitsNb", skip_serializing_if = "Option::is_none")]
    pub units_nb: Option<DecimalNumber>,
    #[serde(rename = "PctgOfTtlSbcptAmt", skip_serializing_if = "Option::is_none")]
...
pub struct FinancialInstrumentQuantity29Choice {
    #[serde(flatten)]
    pub value: FinancialInstrumentQuantity29ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SwitchOrder7 {
    ...
    pub rltd_pty_dtls: Vec<Intermediary40>,
    ...
    pub xpry_dt_tm: Option<DateAndDateTimeChoice>,
    #[serde(rename = "CxlRght", skip_serializing_if = "Option::is_none")]
    pub cxl_rght: Option<CancellationRight1Choice>,
    #[validate(length(min = 1,))]
    #[serde(rename = "RedLegDtls", default)]
    pub red_leg_dtls: Vec<SwitchRedemptionLegOrder6>,
    #[validate(length(min = 1,))]
    #[serde(rename = "SbcptLegDtls", default)]
    pub sbcpt_leg_dtls: Vec<SwitchSubscriptionLegOrder6>,
    #[serde(rename = "CshSttlmDtls", skip_serializing_if = "Option::is_none")]
    pub csh_sttlm_dtls: Option<PaymentTransaction71>,
    #[serde(rename = "FXDtls", skip_serializing_if = "Option::is_none")]
    pub fx_dtls: Option<ForeignExchangeTerms32>,
...
pub struct PaymentTransaction71 {
    #[serde(rename = "CshInOrOut")]
    pub csh_in_or_out: CashInOrOut7Choice,
}
#[derive(
    Debug,
    Default,
...
pub struct FundSettlementParameters11 {
    #[serde(rename = "SttlmDt", skip_serializing_if = "Option::is_none")]
    pub sttlm_dt: Option<IsoDate>,
    #[validate]
    #[serde(rename = "SttlmPlc")]
    ...
    pub sttlm_tx_cond: Vec<SettlementTransactionCondition30Choice>,
    #[validate]
    #[serde(rename = "RcvgSdDtls")]
    pub rcvg_sd_dtls: ReceivingPartiesAndAccount16,
    #[serde(rename = "DlvrgSdDtls", skip_serializing_if = "Option::is_none")]
    pub dlvrg_sd_dtls: Option<DeliveringPartiesAndAccount16>,
}
#[derive(
    Debug,
    Default,
...
pub struct PaymentInstrument21ChoiceEnum {
    #[serde(rename = "CshAcctDtls", skip_serializing_if = "Option::is_none")]
    pub csh_acct_dtls: Option<InvestmentAccount60>,
    #[serde(rename = "CdtTrfDtls", skip_serializing_if = "Option::is_none")]
    pub cdt_trf_dtls: Option<CreditTransfer8>,
...
pub struct PaymentInstrument21Choice {
    #[serde(flatten)]
    pub value: PaymentInstrument21ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct SwitchRedemptionLegOrder6 {
    #[serde(rename = "LegId", skip_serializing_if = "Option::is_none")]
    pub leg_id: Option<Max35Text>,
    #[validate]
    #[serde(rename = "FinInstrmDtls")]
    pub fin_instrm_dtls: FinancialInstrument57,
    #[serde(rename = "FinInstrmQtyChc", skip_serializing_if = "Option::is_none")]
    pub fin_instrm_qty_chc: Option<FinancialInstrumentQuantity29Choice>,
    #[serde(rename = "InvstmtAcctDtls", skip_serializing_if = "Option::is_none")]
    pub invstmt_acct_dtls: Option<InvestmentAccount58>,
    #[serde(rename = "IncmPref", skip_serializing_if = "Option::is_none")]
    pub incm_pref: Option<IncomePreference1Code>,
