...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.057.001.02".to_string()
}
...
pub struct Document {
    #[validate]
    #[serde(rename = "OrdrConfStsRpt")]
    pub ordr_conf_sts_rpt: OrderConfirmationStatusReportV02,
...
pub struct ConfirmationRejectedReason1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
...
pub struct ConfirmationRejectedReason1Choice {
    #[serde(flatten)]
    pub value: ConfirmationRejectedReason1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ConfirmationRejectedStatus2 {
    ...
    pub rsn: Option<ConfirmationRejectedReason1Choice>,
...
pub struct OrderConfirmationStatusReportV02 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    #[serde(rename = "IndvOrdrConfDtlsRpt", default)]
    pub indv_ordr_conf_dtls_rpt: Vec<IndividualOrderConfirmationStatusAndReason2>,
...
pub struct IndividualOrderConfirmationStatusAndReason2 {
...
pub struct ConfirmationStatus1ChoiceEnum {
    #[serde(rename = "Sts", skip_serializing_if = "Option::is_none")]
    pub sts: Option<OrderConfirmationStatus1Code>,
    #[serde(rename = "ConfRjctd", skip_serializing_if = "Option::is_none")]
    pub conf_rjctd: Option<ConfirmationRejectedStatus2>,
    #[serde(rename = "AmdmntRjctd", skip_serializing_if = "Option::is_none")]
    pub amdmnt_rjctd: Option<ConfirmationRejectedStatus2>,
}
#[derive(
    Debug,
    Default,
...
pub struct ConfirmationStatus1Choice {
    #[serde(flatten)]
    pub value: ConfirmationStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
