...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.058.001.02".to_string()
}
...
pub struct RequestForOrderConfirmationStatusReportV02 {
    #[validate]
    #[serde(rename = "MsgId")]
...
pub struct Document {
    #[validate]
    #[serde(rename = "ReqForOrdrConfStsRpt")]
    pub req_for_ordr_conf_sts_rpt: RequestForOrderConfirmationStatusReportV02,
