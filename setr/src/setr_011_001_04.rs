...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.011.001.04".to_string()
}
...
pub struct Document {
    #[validate]
    #[serde(rename = "SbcptOrdrCxlReq")]
    pub sbcpt_ordr_cxl_req: SubscriptionOrderCancellationRequestV04,
...
pub struct SubscriptionOrderCancellationRequestV04 {
    #[validate]
    #[serde(rename = "MsgId")]
