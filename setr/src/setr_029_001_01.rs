...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.029.001.01".to_string()
}
...
pub struct SecuritiesTradeConfirmationCancellationV01<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Id")]
...
> {
    #[validate]
    #[serde(rename = "SctiesTradConfCxl")]
    pub scties_trad_conf_cxl: SecuritiesTradeConfirmationCancellationV01<A>,
