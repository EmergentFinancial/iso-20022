...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:setr.010.001.04".to_string()
}
...
pub struct Document {
    #[validate]
    #[serde(rename = "SbcptOrdr")]
    pub sbcpt_ordr: SubscriptionOrderV04,
...
pub struct SubscriptionMultipleOrder6 {
    ...
    pub indv_ordr_dtls: Vec<SubscriptionOrder14>,
...
pub struct SubscriptionOrderV04 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    pub mltpl_ordr_dtls: SubscriptionMultipleOrder6,
...
pub struct FinancialInstrumentQuantity27ChoiceEnum {
...
pub struct FinancialInstrumentQuantity27Choice {
    #[serde(flatten)]
    pub value: FinancialInstrumentQuantity27ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SubscriptionOrder14 {
    #[validate]
    ...
    #[serde(rename = "AmtOrUnits")]
    pub amt_or_units: FinancialInstrumentQuantity27Choice,
