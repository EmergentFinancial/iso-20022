...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.014.001.05".to_string()
}
...
pub struct MemberReportOrError7ChoiceEnum {
...
pub struct MemberReportOrError7Choice {
    #[serde(flatten)]
    pub value: MemberReportOrError7ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct MemberReportOrError8ChoiceEnum {
...
pub struct MemberReportOrError8Choice {
    #[serde(flatten)]
    pub value: MemberReportOrError8ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct PaymentRole1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct PaymentRole1Choice {
    #[serde(flatten)]
    pub value: PaymentRole1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
