...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.028.001.11".to_string()
}
...
pub struct PaymentComplementaryInformation10 {
    ...
    pub prvs_instg_agt_1: Option<BranchAndFinancialInstitutionIdentification6>,
    ...
    pub prvs_instg_agt_2: Option<BranchAndFinancialInstitutionIdentification6>,
    ...
    pub prvs_instg_agt_3: Option<BranchAndFinancialInstitutionIdentification6>,
...
> {
    ...
    pub addtl_pmt_inf: AdditionalPaymentInformationV11<A>,
