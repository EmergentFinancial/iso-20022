...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.046.001.06".to_string()
}
...
> {
    ...
    pub rsvatn_qry_def: Option<ReservationQuery4>,
...
> {
    ...
    pub get_rsvatn: GetReservationV06<A>,
...
pub struct ReservationQuery4 {
    ...
    pub rsvatn_crit: Option<ReservationCriteria4Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct ReservationSearchCriteria4 {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "DfltRsvatnTp", default)]
    pub dflt_rsvatn_tp: Vec<ReservationType2Choice>,
    #[validate(length(min = 0,))]
    #[serde(rename = "CurRsvatnTp", default)]
...
pub struct ReservationCriteria4ChoiceEnum {
...
pub struct ReservationCriteria4Choice {
    #[serde(flatten)]
    pub value: ReservationCriteria4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
