...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.082.001.01".to_string()
}
...
> {
    ...
    pub intra_bal_mvmnt_cxl_qry: IntraBalanceMovementCancellationQueryV01<A>,
...
pub struct CancellationProcessingStatus9ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct CancellationProcessingStatus9Choice {
    #[serde(flatten)]
    pub value: CancellationProcessingStatus9ChoiceEnum,
}
#[derive(
    Debug,
    Default,
