...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.039.001.05".to_string()
}
...
> {
    ...
    #[serde(rename = "Sts")]
    pub sts: CaseStatus2,
    #[serde(rename = "NewAssgnmt", skip_serializing_if = "Option::is_none")]
    pub new_assgnmt: Option<CaseAssignment5>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub case_sts_rpt: CaseStatusReportV05<A>,
