...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.071.001.04".to_string()
}
...
pub struct StandingOrderOrAll3ChoiceEnum {
    #[serde(rename = "StgOrdr", skip_serializing_if = "Option::is_none")]
    pub stg_ordr: Option<StandingOrderIdentification6>,
    #[serde(rename = "AllStgOrdrs", skip_serializing_if = "Option::is_none")]
    pub all_stg_ordrs: Option<StandingOrderIdentification7>,
}
#[derive(
    Debug,
    Default,
...
pub struct StandingOrderOrAll3Choice {
    #[serde(flatten)]
    pub value: StandingOrderOrAll3ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub del_stg_ordr: DeleteStandingOrderV04<A>,
