...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.058.001.08".to_string()
}
...
pub struct NotificationCancellationReason1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct NotificationCancellationReason1Choice {
    #[serde(flatten)]
    pub value: NotificationCancellationReason1ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct NotificationCancellationReason1 {
...
pub struct OriginalNotificationReference12 {
    ...
    pub xpctd_val_dt: Option<IsoDate>,
    #[serde(rename = "Dbtr", skip_serializing_if = "Option::is_none")]
    pub dbtr: Option<Party40Choice>,
    #[serde(rename = "DbtrAgt", skip_serializing_if = "Option::is_none")]
    pub dbtr_agt: Option<BranchAndFinancialInstitutionIdentification6>,
...
> {
    ...
    pub ntfctn_to_rcv_cxl_advc: NotificationToReceiveCancellationAdviceV08<A>,
...
> {
    ...
    pub cxl_rsn: Option<NotificationCancellationReason1>,
}
#[derive(
    Debug,
    Default,
...
pub struct OriginalNotification14 {
    ...
    #[serde(rename = "NtfctnCxl", skip_serializing_if = "Option::is_none")]
    pub ntfctn_cxl: Option<GroupCancellationIndicator>,
    #[validate(length(min = 0,))]
    #[serde(rename = "OrgnlNtfctnRef", default)]
...
pub struct OriginalItem7 {
    ...
    pub orgnl_itm_ref: Option<OriginalItemReference6>,
}
#[derive(
    Debug,
    Default,
