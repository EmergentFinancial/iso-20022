...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.047.001.07".to_string()
}
...
> {
    ...
    pub rtr_rsvatn: ReturnReservationV07<A>,
...
pub struct ReservationIdentification3 {
    #[serde(rename = "RsvatnId", skip_serializing_if = "Option::is_none")]
...
pub struct ReservationType2ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct ReservationType2Choice {
    #[serde(flatten)]
    pub value: ReservationType2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ReservationStatus1ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct ReservationStatus1Choice {
    #[serde(flatten)]
    pub value: ReservationStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ReservationOrError9ChoiceEnum {
...
pub struct ReservationOrError9Choice {
    #[serde(flatten)]
    pub value: ReservationOrError9ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CurrentAndDefaultReservation5 {
    ...
    #[serde(rename = "CurRsvatn", default)]
    pub cur_rsvatn: Vec<ReservationReport7>,
    #[validate(length(min = 0,))]
    #[serde(rename = "DfltRsvatn", default)]
...
pub struct ReservationOrError10ChoiceEnum {
...
pub struct ReservationOrError10Choice {
    #[serde(flatten)]
    pub value: ReservationOrError10ChoiceEnum,
}
#[derive(
    Debug,
    Default,
