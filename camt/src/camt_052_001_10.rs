...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.052.001.10".to_string()
}
...
> {
    ...
    pub bk_to_cstmr_acct_rpt: BankToCustomerAccountReportV10<A, B>,
...
pub struct CreditLineType1ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct CreditLineType1Choice {
    #[serde(flatten)]
    pub value: CreditLineType1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct BankToCustomerAccountReportV10<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
...
pub struct BalanceType10ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct BalanceType10Choice {
    #[serde(flatten)]
    pub value: BalanceType10ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct BalanceSubType1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct BalanceSubType1Choice {
    #[serde(flatten)]
    pub value: BalanceSubType1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
