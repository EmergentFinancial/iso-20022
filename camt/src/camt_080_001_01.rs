...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.080.001.01".to_string()
}
...
pub struct ModificationProcessingStatus9ChoiceEnum {
...
pub struct ModificationProcessingStatus9Choice {
    #[serde(flatten)]
    pub value: ModificationProcessingStatus9ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub intra_bal_mvmnt_mod_qry: IntraBalanceMovementModificationQueryV01<A>,
