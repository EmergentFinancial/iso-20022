...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.011.001.07".to_string()
}
...
pub struct LimitIdentification2ChoiceEnum {
    #[serde(rename = "Dflt", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "AllCur", skip_serializing_if = "Option::is_none")]
    pub all_cur: Option<LimitIdentification6>,
    #[serde(rename = "AllDflt", skip_serializing_if = "Option::is_none")]
...
pub struct LimitIdentification2Choice {
    #[serde(flatten)]
    pub value: LimitIdentification2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub modfy_lmt: ModifyLimitV07<A>,
