...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.055.001.11".to_string()
}
...
pub struct CustomerPaymentCancellationRequestV11<
...
> {
    ...
    pub undrlyg: Vec<UnderlyingTransaction30<A>>,
...
pub struct OriginalPaymentInstruction44<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "PmtCxlId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "PmtInfCxl", skip_serializing_if = "Option::is_none")]
    pub pmt_inf_cxl: Option<GroupCancellationIndicator>,
    #[validate(length(min = 0,))]
    #[serde(rename = "CxlRsnInf", default)]
    pub cxl_rsn_inf: Vec<PaymentCancellationReason5>,
    #[validate(length(min = 0,))]
    #[serde(rename = "TxInf", default)]
    pub tx_inf: Vec<PaymentTransaction140<A>>,
}
#[derive(
    Debug,
    Default,
...
pub struct OriginalGroupHeader15 {
    ...
    pub grp_cxl: Option<GroupCancellationIndicator>,
    #[validate(length(min = 0,))]
    #[serde(rename = "CxlRsnInf", default)]
    pub cxl_rsn_inf: Vec<PaymentCancellationReason5>,
}
...
> {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "OrgnlPmtInfAndCxl", default)]
    pub orgnl_pmt_inf_and_cxl: Vec<OriginalPaymentInstruction44<A>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub cstmr_pmt_cxl_req: CustomerPaymentCancellationRequestV11<A, B>,
...
pub struct CancellationReason33ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct CancellationReason33Choice {
    #[serde(flatten)]
    pub value: CancellationReason33ChoiceEnum,
}
#[derive(
    Debug,
    Default,
