...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.085.001.01".to_string()
}
...
> {
    ...
    #[serde(rename = "Mvmnts", default)]
    pub mvmnts: Vec<IntraBalancePending5<A>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub intra_bal_mvmnt_pdg_rpt: IntraBalanceMovementPendingReportV01<A>,
...
pub struct ProcessingStatus66ChoiceEnum {
...
pub struct ProcessingStatus66Choice {
    #[serde(flatten)]
    pub value: ProcessingStatus66ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub mvmnt: Vec<IntraBalancePending6<A>>,
}
#[derive(
    Debug,
    Default,
