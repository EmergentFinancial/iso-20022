...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.062.001.03".to_string()
}
...
> {
    ...
    pub pay_in_schdl: PayInScheduleV03<A>,
...
> {
    ...
    #[serde(rename = "PayInSchdlLngBal", default)]
    pub pay_in_schdl_lng_bal: Vec<BalanceStatus2>,
    #[validate(length(min = 0,))]
    #[serde(rename = "PayInSchdlItm", default)]
