...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.109.001.01".to_string()
}
...
pub struct ChequeCancellationStatus1ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct ChequeCancellationStatus1Choice {
    #[serde(flatten)]
    pub value: ChequeCancellationStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub chq_cxl_or_stop_rpt: ChequeCancellationOrStopReportV01<A>,
