...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.017.001.05".to_string()
}
...
pub struct ExchangeRateReportOrError3ChoiceEnum {
    #[serde(rename = "CcyXchgRpt", skip_serializing_if = "Option::is_none")]
    pub ccy_xchg_rpt: Option<CurrencyExchangeReport4>,
    #[serde(rename = "OprlErr", skip_serializing_if = "Option::is_none")]
    pub oprl_err: Option<ErrorHandling3>,
}
#[derive(
    Debug,
    Default,
...
pub struct ExchangeRateReportOrError3Choice {
    #[serde(flatten)]
    pub value: ExchangeRateReportOrError3ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ErrorHandling1ChoiceEnum {
...
pub struct ErrorHandling1Choice {
    #[serde(flatten)]
    pub value: ErrorHandling1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ExchangeRateReportOrError4ChoiceEnum {
...
pub struct ExchangeRateReportOrError4Choice {
    #[serde(flatten)]
    pub value: ExchangeRateReportOrError4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub rtr_ccy_xchg_rate: ReturnCurrencyExchangeRateV05<A>,
...
pub struct ExchangeRateOrPercentage1ChoiceEnum {
...
pub struct ExchangeRateOrPercentage1Choice {
    #[serde(flatten)]
    pub value: ExchangeRateOrPercentage1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
