...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.012.001.07".to_string()
}
...
pub struct LimitStructure2ChoiceEnum {
...
pub struct LimitStructure2Choice {
    #[serde(flatten)]
    pub value: LimitStructure2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
