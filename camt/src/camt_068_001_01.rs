...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:camt.068.001.01".to_string()
}
...
> {
    ...
    pub intra_bal_mvmnt_conf: IntraBalanceMovementConfirmationV01<A>,
...
> {
    ...
    pub addtl_params: Option<AdditionalParameters16>,
    #[validate]
