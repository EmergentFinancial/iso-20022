...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caad.003.001.02".to_string()
}
...
pub struct BatchTransferInitiationV02<
...
> {
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: BatchTransferInitiation2<A>,
...
> {
    #[validate]
    #[serde(rename = "BtchTrfInitn")]
    pub btch_trf_initn: BatchTransferInitiationV02<A>,
...
pub struct BatchTransferInitiation2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
    ...
    pub prcg_rslt: Option<ProcessingResult20>,
    #[validate(length(min = 0,))]
