...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caad.005.001.03".to_string()
}
...
pub struct TransactionTotals13 {
    #[serde(rename = "Rcncltn", skip_serializing_if = "Option::is_none")]
    pub rcncltn: Option<Reconciliation3>,
    #[validate(length(min = 0,))]
    #[serde(rename = "FinRcncltn", default)]
    pub fin_rcncltn: Vec<FinancialReconciliation2>,
    #[validate(length(min = 0,))]
    #[serde(rename = "MsgRcncltn", default)]
    pub msg_rcncltn: Vec<MessageReconciliation3>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AddtlFeeRcncltn", default)]
    pub addtl_fee_rcncltn: Vec<AdditionalFeeReconciliation2>,
    #[validate]
    #[serde(rename = "Ccy")]
    pub ccy: Min2Max3NumericText,
    #[serde(rename = "NetAmtRcncltn", skip_serializing_if = "Option::is_none")]
    pub net_amt_rcncltn: Option<Amount16>,
}
#[derive(
    Debug,
    Default,
...
pub struct MessageReconciliation3 {
    #[serde(rename = "Tp")]
...
> {
    #[validate]
    #[serde(rename = "RcncltnInitn")]
    pub rcncltn_initn: ReconciliationInitiationV03<A>,
...
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
pub enum ReconciliationActivityType1Code {
    #[serde(rename = "ACQG")]
    Acqg,
    #[serde(rename = "CNSD")]
    Cnsd,
...
pub struct ReconciliationInitiation2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
...
pub struct Transaction135 {
    #[serde(rename = "RcncltnFctn")]
    pub rcncltn_fctn: ReconciliationFunction1Code,
    #[serde(rename = "RcncltnActvtyTp", skip_serializing_if = "Option::is_none")]
    pub rcncltn_actvty_tp: Option<ReconciliationActivityType1Code>,
    #[serde(
        rename = "OthrRcncltnActvtyTp",
        skip_serializing_if = "Option::is_none"
    )]
    pub othr_rcncltn_actvty_tp: Option<Max35Text>,
    #[serde(rename = "RcncltnTp")]
    pub rcncltn_tp: CardServiceType4Code,
    #[serde(rename = "OthrRcncltnTp", skip_serializing_if = "Option::is_none")]
    pub othr_rcncltn_tp: Option<Max35Text>,
    #[serde(rename = "TxId", skip_serializing_if = "Option::is_none")]
    pub tx_id: Option<TransactionIdentification12>,
    #[validate(length(min = 0,))]
    #[serde(rename = "ReqdCcy", default)]
    pub reqd_ccy: Vec<Exact3NumericText>,
    #[validate(length(min = 0,))]
    #[serde(rename = "RcncltnTtls", default)]
    pub rcncltn_ttls: Vec<TransactionTotals13>,
    #[validate(length(min = 0,))]
...
pub struct ReconciliationInitiationV03<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: ReconciliationInitiation2<A>,
...
pub struct AdditionalFeeReconciliation2 {
    #[serde(rename = "RcncltnImpct")]
...
pub struct FinancialReconciliation2 {
    #[serde(rename = "RcncltnImpct")]
    pub rcncltn_impct: ReconciliationImpact1Code,
    #[serde(rename = "Tp")]
