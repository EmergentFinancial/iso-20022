...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caad.009.001.01".to_string()
}
...
pub struct AdministrativeResponseV01<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: AdministrativeResponse1<A>,
...
> {
    #[validate]
    #[serde(rename = "AdmstvRspn")]
    pub admstv_rspn: AdministrativeResponseV01<A>,
...
pub struct AdministrativeResponse1<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
