...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:canm.003.001.03".to_string()
}
...
pub struct KeyExchangeData1 {
    ...
    pub ncrptd_data: Option<Max9999HexBinaryText>,
    #[serde(rename = "KeyChcksmVal", skip_serializing_if = "Option::is_none")]
    pub key_chcksm_val: Option<Max9999HexBinaryText>,
}
#[derive(
    Debug,
    Default,
...
pub struct KeyExchangeInitiation2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
...
pub struct Transaction133 {
    #[serde(rename = "KeyXchgFctn")]
    pub key_xchg_fctn: CardServiceType5Code,
    #[serde(rename = "OthrKeyXchgFctn", skip_serializing_if = "Option::is_none")]
    pub othr_key_xchg_fctn: Option<Max35Text>,
    #[validate(length(min = 0,))]
    ...
    #[serde(rename = "KeyXchgTp", skip_serializing_if = "Option::is_none")]
    pub key_xchg_tp: Option<KeyType1Code>,
    #[serde(rename = "OthrKeyXchgTp", skip_serializing_if = "Option::is_none")]
    pub othr_key_xchg_tp: Option<Max35Text>,
    #[serde(rename = "KeyXchgData", skip_serializing_if = "Option::is_none")]
    pub key_xchg_data: Option<KeyExchangeData1>,
    #[validate(length(min = 0,))]
...
> {
    #[validate]
    #[serde(rename = "KeyXchgInitn")]
    pub key_xchg_initn: KeyExchangeInitiationV03<A>,
...
pub struct KeyExchangeInitiationV03<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: KeyExchangeInitiation2<A>,
