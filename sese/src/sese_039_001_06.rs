...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.039.001.06".to_string()
}
...
pub struct TransactionDetails155 {
    #[validate]
...
> {
    ...
    pub scties_sttlm_tx_mod_req_sts_advc:
        SecuritiesSettlementTransactionModificationRequestStatusAdviceV06<A>,
...
pub struct SecuritiesSettlementTransactionModificationRequestStatusAdviceV06<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    ...
    pub tx_id: Option<TransactionIdentifications33>,
    #[serde(rename = "ModPrcgSts")]
    pub mod_prcg_sts: ModificationProcessingStatus10Choice,
    #[serde(rename = "TxDtls", skip_serializing_if = "Option::is_none")]
    pub tx_dtls: Option<TransactionDetails155>,
    #[validate(length(min = 0,))]
