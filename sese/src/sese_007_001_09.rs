...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.007.001.09".to_string()
}
...
pub struct TransferInConfirmationV09 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    pub fctn: Option<TransferInFunction2Code>,
    ...
    pub sttlm_dtls: Option<DeliverInformation20>,
...
pub struct Document {
    #[validate]
    #[serde(rename = "TrfInConf")]
    pub trf_in_conf: TransferInConfirmationV09,
...
pub struct DeliverInformation20 {
