...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.022.001.06".to_string()
}
...
pub struct ProcessingStatus89ChoiceEnum {
    #[serde(rename = "Rjctd", skip_serializing_if = "Option::is_none")]
    pub rjctd: Option<RejectionOrRepairStatus44Choice>,
...
pub struct ProcessingStatus89Choice {
    #[serde(flatten)]
    pub value: ProcessingStatus89ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Identification28 {
    ...
    pub mstr_id: Option<Max35Text>,
    #[serde(rename = "BsktId", skip_serializing_if = "Option::is_none")]
    pub bskt_id: Option<Max35Text>,
    ...
    pub list_id: Option<Max35Text>,
    #[serde(rename = "PrgmId", skip_serializing_if = "Option::is_none")]
    pub prgm_id: Option<Max35Text>,
...
pub struct DocumentIdentification54 {
...
pub struct DocumentNumber18 {
    #[serde(rename = "Nb")]
    pub nb: DocumentNumber5Choice,
    #[validate(length(min = 1,))]
    #[serde(rename = "Refs", default)]
    pub refs: Vec<Identification28>,
}
#[derive(
    Debug,
    Default,
...
pub struct SecuritiesStatusOrStatementQueryStatusAdviceV06<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "QryDtls")]
    pub qry_dtls: DocumentIdentification54,
    ...
    pub sts_or_stmt_reqd: Option<StatusOrStatement11Choice>,
    #[serde(rename = "PrcgSts")]
    pub prcg_sts: ProcessingStatus89Choice,
    #[validate(length(min = 0,))]
...
pub struct StatusOrStatement11ChoiceEnum {
    #[serde(rename = "Stmt", skip_serializing_if = "Option::is_none")]
    pub stmt: Option<DocumentNumber13>,
    #[serde(rename = "StsAdvc", skip_serializing_if = "Option::is_none")]
    pub sts_advc: Option<DocumentNumber18>,
}
#[derive(
    Debug,
    Default,
...
pub struct StatusOrStatement11Choice {
    #[serde(flatten)]
    pub value: StatusOrStatement11ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectionAndRepairReason39ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct RejectionAndRepairReason39Choice {
    #[serde(flatten)]
    pub value: RejectionAndRepairReason39ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
> {
    ...
    pub scties_sts_or_stmt_qry_sts_advc: SecuritiesStatusOrStatementQueryStatusAdviceV06<A>,
...
pub struct RejectionOrRepairStatus44ChoiceEnum {
    #[serde(rename = "NoSpcfdRsn", skip_serializing_if = "Option::is_none")]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<RejectionOrRepairReason39>,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectionOrRepairStatus44Choice {
    #[serde(flatten)]
    pub value: RejectionOrRepairStatus44ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectionOrRepairReason39 {
    #[serde(rename = "Cd")]
    pub cd: RejectionAndRepairReason39Choice,
    #[serde(rename = "AddtlRsnInf", skip_serializing_if = "Option::is_none")]
    pub addtl_rsn_inf: Option<Max210Text>,
}
#[derive(
