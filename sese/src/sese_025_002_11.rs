...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.025.002.11".to_string()
}
...
pub struct SecuritiesTransactionType51ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification47>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct SecuritiesTransactionType51Choice {
    #[serde(flatten)]
    pub value: SecuritiesTransactionType51ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub addtl_params: Option<AdditionalParameters31>,
    #[validate]
...
pub struct AdditionalParameters31 {
    ...
    pub prvs_prtl_conf_id: Option<RestrictedFinxMax16Text>,
    #[serde(
...
> {
    ...
    pub scties_sttlm_tx_conf: SecuritiesSettlementTransactionConfirmation002V11<A>,
