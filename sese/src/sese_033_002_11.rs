...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.033.002.11".to_string()
}
...
> {
    ...
    #[validate]
    #[serde(rename = "TxTpAndAddtlParams")]
    ...
    pub opng_sttlm_amt: Option<AmountAndDirection96>,
...
> {
    #[validate]
    #[serde(rename = "SctiesFincgInstr")]
    pub scties_fincg_instr: SecuritiesFinancingInstruction002V11<A>,
