...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.035.002.11".to_string()
}
...
> {
    ...
    pub scties_fincg_conf: SecuritiesFinancingConfirmation002V11<A>,
...
> {
    ...
    pub addtl_params: Option<AdditionalParameters26>,
    #[validate]
    ...
    pub scties_fincg_dtls: Option<SecuritiesFinancingTransactionDetails46>,
    ...
    pub sttlm_params: Option<SettlementDetails151>,
    ...
    pub othr_amts: Option<OtherAmounts42>,
...
pub struct QuantityAndAccount103 {
    ...
    pub prevsly_sttld_amt: Option<AmountAndDirection19>,
    #[serde(rename = "RmngToBeSttldAmt", skip_serializing_if = "Option::is_none")]
    pub rmng_to_be_sttld_amt: Option<AmountAndDirection19>,
