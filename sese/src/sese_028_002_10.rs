...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.028.002.10".to_string()
}
...
> {
    ...
    pub scties_sttlm_tx_allgmt_ntfctn:
        SecuritiesSettlementTransactionAllegementNotification002V10<A>,
...
pub struct SettlementTransactionCondition36ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification47>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct SettlementTransactionCondition36Choice {
    #[serde(flatten)]
    pub value: SettlementTransactionCondition36ChoiceEnum,
}
#[derive(
    Debug,
    Default,
