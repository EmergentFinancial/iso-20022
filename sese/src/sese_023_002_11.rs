...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.023.002.11".to_string()
}
...
pub struct References50ChoiceEnum {
...
pub struct References50Choice {
    #[serde(flatten)]
    pub value: References50ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "SctiesSttlmTxInstr")]
    pub scties_sttlm_tx_instr: SecuritiesSettlementTransactionInstruction002V11<A>,
...
pub struct SecuritiesTransactionType53ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification47>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct SecuritiesTransactionType53Choice {
    #[serde(flatten)]
    pub value: SecuritiesTransactionType53ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SettlementTransactionCondition39ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification47>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct SettlementTransactionCondition39Choice {
    #[serde(flatten)]
    pub value: SettlementTransactionCondition39ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SettlementDetails207 {
    ...
    #[serde(
        rename = "DlvrgSctiesSubBalTp",
        skip_serializing_if = "Option::is_none"
    )]
    pub dlvrg_scties_sub_bal_tp: Option<GenericIdentification30>,
    #[serde(rename = "RcvgSctiesSubBalTp", skip_serializing_if = "Option::is_none")]
    pub rcvg_scties_sub_bal_tp: Option<GenericIdentification30>,
