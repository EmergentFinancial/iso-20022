...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.001.001.09".to_string()
}
...
pub struct ReceiveInformation21 {
...
pub struct Document {
    #[validate]
    #[serde(rename = "TrfOutInstr")]
    pub trf_out_instr: TransferOutInstructionV09,
...
pub struct TransferOutInstructionV09 {
    #[validate]
    #[serde(rename = "MsgId")]
    ...
    pub sttlm_dtls: Option<ReceiveInformation21>,
