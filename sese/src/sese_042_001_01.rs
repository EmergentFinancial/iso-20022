...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.042.001.01".to_string()
}
...
pub struct AcknowledgementReason24ChoiceEnum {
...
pub struct AcknowledgementReason24Choice {
    #[serde(flatten)]
    pub value: AcknowledgementReason24ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    #[serde(rename = "BuyInRgltryAdvcRspn")]
    pub buy_in_rgltry_advc_rspn: BuyInRegulatoryAdviceResponseV01<A>,
...
pub struct RejectionOrRepairStatus31ChoiceEnum {
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<RejectionOrRepairReason25>,
...
pub struct RejectionOrRepairStatus31Choice {
    #[serde(flatten)]
    pub value: RejectionOrRepairStatus31ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct RejectionAndRepairReason25ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct RejectionAndRepairReason25Choice {
    #[serde(flatten)]
    pub value: RejectionAndRepairReason25ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct AcknowledgedAcceptedStatus33ChoiceEnum {
    #[serde(rename = "NoSpcfdRsn", skip_serializing_if = "Option::is_none")]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<AcknowledgementReason21>,
}
#[derive(
    Debug,
    Default,
...
pub struct AcknowledgedAcceptedStatus33Choice {
    #[serde(flatten)]
    pub value: AcknowledgedAcceptedStatus33ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct BuyInRegulatoryAdviceResponseV01<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "AdvcRef")]
...
pub struct ProcessingStatus79ChoiceEnum {
...
pub struct ProcessingStatus79Choice {
    #[serde(flatten)]
    pub value: ProcessingStatus79ChoiceEnum,
}
#[derive(
    Debug,
    Default,
