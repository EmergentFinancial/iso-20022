...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.040.001.04".to_string()
}
...
pub struct ConsentOrRejectionReason4ChoiceEnum {
...
pub struct ConsentOrRejectionReason4Choice {
    #[serde(flatten)]
    pub value: ConsentOrRejectionReason4ChoiceEnum,
}
...
pub struct RejectionStatus20ChoiceEnum {
...
pub struct RejectionStatus20Choice {
    #[serde(flatten)]
    pub value: RejectionStatus20ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct PendingStatus20ChoiceEnum {
    #[serde(rename = "UdrInvstgtn", skip_serializing_if = "Option::is_none")]
    pub udr_invstgtn: Option<NoSpecifiedReason1>,
    #[serde(rename = "Fwdd", skip_serializing_if = "Option::is_none")]
...
pub struct PendingStatus20Choice {
    #[serde(flatten)]
    pub value: PendingStatus20ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct TransactionDetails149 {
    #[validate]
...
pub struct ResponseStatus6ChoiceEnum {
    #[serde(rename = "Pdg", skip_serializing_if = "Option::is_none")]
    pub pdg: Option<PendingStatus20Choice>,
    #[serde(rename = "Cnsntd", skip_serializing_if = "Option::is_none")]
...
pub struct ResponseStatus6Choice {
    #[serde(flatten)]
    pub value: ResponseStatus6ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SecuritiesSettlementTransactionCounterpartyResponseV04<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "TxId")]
    pub tx_id: TransactionIdentification6,
    #[serde(rename = "RspnSts")]
    pub rspn_sts: ResponseStatus6Choice,
    #[serde(rename = "TxDtls", skip_serializing_if = "Option::is_none")]
    pub tx_dtls: Option<TransactionDetails149>,
...
pub struct ConsentStatus4ChoiceEnum {
    #[serde(rename = "NoSpcfdRsn", skip_serializing_if = "Option::is_none")]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<ConsentReason4>,
}
#[derive(
    Debug,
    Default,
...
pub struct ConsentStatus4Choice {
    #[serde(flatten)]
    pub value: ConsentStatus4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "SctiesSttlmTxCtrPtyRspn")]
    pub scties_sttlm_tx_ctr_pty_rspn: SecuritiesSettlementTransactionCounterpartyResponseV04<A>,
