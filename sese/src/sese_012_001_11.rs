...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.012.001.11".to_string()
}
...
pub struct FundPortfolio8ChoiceEnum {
...
pub struct FundPortfolio8Choice {
    #[serde(flatten)]
    pub value: FundPortfolio8ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct PortfolioTransfer11 {
    ...
    #[serde(rename = "ReqdTrfDt", skip_serializing_if = "Option::is_none")]
    pub reqd_trf_dt: Option<IsoDate>,
    #[serde(rename = "Prtfl", skip_serializing_if = "Option::is_none")]
    pub prtfl: Option<FundPortfolio8Choice>,
    ...
    pub fin_instrm_asst_for_trf: Vec<FinancialInstrument102>,
    #[validate(length(min = 0,))]
...
pub struct FinancialInstrument102 {
...
pub struct PortfolioTransferInstructionV11 {
    #[validate]
    #[serde(rename = "MsgRef")]
    ...
    pub pdct_trf: Vec<PortfolioTransfer11>,
...
pub struct Document {
    #[validate]
    #[serde(rename = "PrtflTrfInstr")]
    pub prtfl_trf_instr: PortfolioTransferInstructionV11,
