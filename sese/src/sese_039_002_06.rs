...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.039.002.06".to_string()
}
...
> {
    #[serde(rename = "SctiesSttlmTxModReqStsAdvc")]
    pub scties_sttlm_tx_mod_req_sts_advc:
        SecuritiesSettlementTransactionModificationRequestStatusAdvice002V06<A>,
...
> {
    ...
    pub tx_id: Option<TransactionIdentifications37>,
    #[serde(rename = "ModPrcgSts")]
    pub mod_prcg_sts: ModificationProcessingStatus11Choice,
    #[serde(rename = "TxDtls", skip_serializing_if = "Option::is_none")]
    pub tx_dtls: Option<TransactionDetails158>,
    #[validate(length(min = 0,))]
...
pub struct TransactionIdentifications37 {
    ...
    pub othr_id: Option<RestrictedFinxMax16Text>,
}
#[derive(
    Debug,
    Default,
