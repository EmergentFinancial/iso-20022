...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:sese.005.001.09".to_string()
}
...
pub struct DeliverInformation21 {
    #[serde(rename = "Trfr", skip_serializing_if = "Option::is_none")]
    pub trfr: Option<PartyIdentification139>,
    #[serde(rename = "TrfrRegdAcct", skip_serializing_if = "Option::is_none")]
    pub trfr_regd_acct: Option<Account31>,
...
pub struct DateFormat1ChoiceEnum {
...
pub struct DateFormat1Choice {
    #[serde(flatten)]
    pub value: DateFormat1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[validate]
    #[serde(rename = "TrfInInstr")]
    pub trf_in_instr: TransferInInstructionV09,
...
pub struct InvestmentAccount71 {
    #[validate(length(min = 0,))]
...
pub struct TransferInInstructionV09 {
    #[validate]
    #[serde(rename = "MsgId")]
...
pub struct Quantity42ChoiceEnum {
...
pub struct Quantity42Choice {
    #[serde(flatten)]
    pub value: Quantity42ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Transfer36 {
    ...
    pub reqd_trf_dt: Option<DateFormat1Choice>,
    #[serde(rename = "ReqdSttlmDt", skip_serializing_if = "Option::is_none")]
    pub reqd_sttlm_dt: Option<IsoDate>,
