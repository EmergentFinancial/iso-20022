...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.04".to_string()
}
...
pub struct TradeAgreement12 {
    ...
    #[serde(rename = "AmdOrCclRsn", skip_serializing_if = "Option::is_none")]
    pub amd_or_ccl_rsn: Option<Max35Text>,
...
> {
    ...
    pub ndf_conds: Option<NonDeliverableForwardConditions2>,
    ...
    pub gnl_inf: Option<GeneralInformation5>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SpltTradInf", default)]
...
> {
    #[validate]
    #[serde(rename = "FXTradStsAndDtlsNtfctn")]
    pub fx_trad_sts_and_dtls_ntfctn: ForeignExchangeTradeStatusAndDetailsNotificationV04<A>,
...
pub struct SplitTradeDetails3 {
    #[serde(rename = "StsDtls", skip_serializing_if = "Option::is_none")]
    pub sts_dtls: Option<TradeData16>,
    #[validate]
    #[serde(rename = "TradAmts")]
    pub trad_amts: AmountsAndValueDate1,
    #[serde(rename = "AgrdRate", skip_serializing_if = "Option::is_none")]
    pub agrd_rate: Option<AgreedRate3>,
}
#[derive(
    Debug,
    Default,
...
pub struct NonDeliverableForwardConditions2 {
    #[validate]
    #[serde(rename = "OpngConds")]
    pub opng_conds: OpeningConditions1,
    #[serde(rename = "FxgConds", skip_serializing_if = "Option::is_none")]
    pub fxg_conds: Option<FixingConditions1>,
}
#[derive(
    Debug,
    Default,
...
pub struct TradeData14 {
    ...
    #[serde(rename = "PrvsSts", skip_serializing_if = "Option::is_none")]
    pub prvs_sts: Option<Status28Choice>,
    #[serde(rename = "AllgdTrad", skip_serializing_if = "Option::is_none")]
    pub allgd_trad: Option<YesNoIndicator>,
    #[serde(rename = "PrvsStsSubTp", skip_serializing_if = "Option::is_none")]
    pub prvs_sts_sub_tp: Option<StatusSubType2Code>,
}
#[derive(
