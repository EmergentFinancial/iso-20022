...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:fxtr.008.001.06".to_string()
}
...
pub struct TradeData15 {
    ...
    pub sts_orgtr: Option<Max20Text>,
    #[validate]
    #[serde(rename = "CurSts")]
    ...
    #[serde(rename = "PrvsStsDtTm", skip_serializing_if = "Option::is_none")]
    pub prvs_sts_dt_tm: Option<IsoDateTime>,
    ...
    #[serde(rename = "SpltTradInd", skip_serializing_if = "Option::is_none")]
    pub splt_trad_ind: Option<YesNoIndicator>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "FXTradStsNtfctn")]
    pub fx_trad_sts_ntfctn: ForeignExchangeTradeStatusNotificationV06<A>,
