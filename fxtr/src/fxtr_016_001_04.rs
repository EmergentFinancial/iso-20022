...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:fxtr.016.001.04".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "FXTradInstrCxl")]
    pub fx_trad_instr_cxl: ForeignExchangeTradeInstructionCancellationV04<A>,
...
pub struct MatchingSystemReference1ChoiceEnum {
    #[serde(rename = "MtchgSysUnqRef", skip_serializing_if = "Option::is_none")]
...
pub struct MatchingSystemReference1Choice {
    #[serde(flatten)]
    pub value: MatchingSystemReference1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
