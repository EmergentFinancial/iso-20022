...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "FXTradInstrAmdmnt")]
    pub fx_trad_instr_amdmnt: ForeignExchangeTradeInstructionAmendmentV04<A>,
