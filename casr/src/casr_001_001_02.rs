...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casr.001.001.02".to_string()
}
...
pub struct SettlementTotals2 {
    #[serde(rename = "AcqrrTtls", skip_serializing_if = "Option::is_none")]
    pub acqrr_ttls: Option<SettlementCategoryTotal2>,
    #[serde(rename = "IssrTtls", skip_serializing_if = "Option::is_none")]
    pub issr_ttls: Option<SettlementCategoryTotal2>,
    #[serde(rename = "OthrTtls", skip_serializing_if = "Option::is_none")]
    pub othr_ttls: Option<SettlementCategoryTotal2>,
    #[serde(rename = "TtlSttlmAmt", skip_serializing_if = "Option::is_none")]
    pub ttl_sttlm_amt: Option<SettlementCategoryTotal2>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "SttlmRptgInitn")]
    pub sttlm_rptg_initn: SettlementReportingInitiationV02<A>,
...
pub struct SettlementReportingInitiation2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
    pub envt: Environment27,
    #[serde(rename = "Cntxt", skip_serializing_if = "Option::is_none")]
    pub cntxt: Option<Context17>,
    #[validate]
    #[serde(rename = "Tx")]
    pub tx: Transaction138,
    #[validate(length(min = 0,))]
...
pub struct FinancialInstitution6 {
    #[validate]
    #[serde(rename = "Id")]
...
pub struct SettlementReportingInitiationV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: SettlementReportingInitiation2<A>,
...
pub struct SettlementCategoryTotal2 {
    ...
    #[serde(rename = "PrcgFee", skip_serializing_if = "Option::is_none")]
    pub prcg_fee: Option<Amount17>,
}
#[derive(
    Debug,
    Default,
...
pub struct Environment27 {
    #[serde(rename = "SttlmInstn", skip_serializing_if = "Option::is_none")]
    pub sttlm_instn: Option<PartyIdentification263>,
    ...
    pub fi: Option<FinancialInstitution6>,
    #[serde(rename = "OthrInstn", skip_serializing_if = "Option::is_none")]
    pub othr_instn: Option<PartyIdentification258>,
}
#[derive(
    Debug,
    Default,
...
pub struct Transaction138 {
    #[serde(rename = "SttlmRptTp")]
    pub sttlm_rpt_tp: SettlementReportType1Code,
    #[serde(rename = "OthrSttlmRptTp", skip_serializing_if = "Option::is_none")]
    pub othr_sttlm_rpt_tp: Option<Max35Text>,
    #[validate(length(min = 0,))]
    ...
    #[serde(rename = "SttlmTtls", skip_serializing_if = "Option::is_none")]
    pub sttlm_ttls: Option<SettlementTotals2>,
    #[serde(rename = "FndsTrfAmt", skip_serializing_if = "Option::is_none")]
    pub fnds_trf_amt: Option<Amount17>,
