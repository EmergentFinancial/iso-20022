...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casr.002.001.02".to_string()
}
...
pub struct SettlementReportingResponseV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: SettlementReportingResponse2<A>,
...
pub struct SettlementReportingResponse2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
...
> {
    #[validate]
    #[serde(rename = "SttlmRptgRspn")]
    pub sttlm_rptg_rspn: SettlementReportingResponseV02<A>,
