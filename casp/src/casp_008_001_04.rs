...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.008.001.04".to_string()
}
...
pub struct SaleToPoiAdministrativeResponseV04<
...
> {
    ...
    pub admstv_rspn: AdministrativeResponse5<A>,
...
pub struct AdministrativeResponse5<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
...
> {
    #[validate]
    #[serde(rename = "SaleToPOIAdmstvRspn")]
    pub sale_to_poi_admstv_rspn: SaleToPoiAdministrativeResponseV04<A>,
