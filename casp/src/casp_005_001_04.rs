...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.005.001.04".to_string()
}
...
pub struct SessionManagementRequest5<
...
> {
    ...
    #[serde(rename = "LgnReq", skip_serializing_if = "Option::is_none")]
    pub lgn_req: Option<LoginRequest4>,
    #[serde(rename = "LgtReq", skip_serializing_if = "Option::is_none")]
    pub lgt_req: Option<LogoutRequest1>,
    #[serde(rename = "DgnssReq", skip_serializing_if = "Option::is_none")]
    pub dgnss_req: Option<DiagnosisRequest1>,
    #[validate(length(min = 0,))]
...
> {
    #[validate]
    #[serde(rename = "SaleToPOISsnMgmtReq")]
    pub sale_to_poi_ssn_mgmt_req: SaleToPoiSessionManagementRequestV04<A>,
...
pub struct SaleToPoiSessionManagementRequestV04<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header41,
    #[validate]
    #[serde(rename = "SsnMgmtReq")]
    pub ssn_mgmt_req: SessionManagementRequest5<A>,
...
pub struct LoginRequest4 {
    #[validate]
    #[serde(rename = "LgnDtTm")]
    pub lgn_dt_tm: IsoDateTime,
    #[validate(length(min = 1,))]
    #[serde(rename = "SaleSftwr", default)]
    pub sale_sftwr: Vec<PointOfInteractionComponent12>,
    #[serde(rename = "SaleTermnlData", skip_serializing_if = "Option::is_none")]
    pub sale_termnl_data: Option<SaleTerminalData1>,
    #[serde(rename = "TrngMdFlg", skip_serializing_if = "Option::is_none")]
    pub trng_md_flg: Option<TrueFalseIndicator>,
    #[serde(rename = "CshrId", skip_serializing_if = "Option::is_none")]
    pub cshr_id: Option<Max35Text>,
    #[serde(rename = "CshrLang")]
    pub cshr_lang: LanguageCode,
    #[serde(rename = "ShftNb", skip_serializing_if = "Option::is_none")]
    pub shft_nb: Option<Max2NumericText>,
    #[serde(rename = "TknReqdTp", skip_serializing_if = "Option::is_none")]
    pub tkn_reqd_tp: Option<SaleTokenScope1Code>,
    #[serde(rename = "CstmrOrdrReq", skip_serializing_if = "Option::is_none")]
    pub cstmr_ordr_req: Option<CustomerOrderRequest1Code>,
    #[serde(rename = "POIId", skip_serializing_if = "Option::is_none")]
    pub poi_id: Option<PointOfInteractionComponentIdentification2>,
    #[serde(rename = "TtlsGrpId", skip_serializing_if = "Option::is_none")]
    pub ttls_grp_id: Option<Max35Text>,
...
pub struct SaleTerminalData1 {
    #[serde(rename = "TermnlEnvt", skip_serializing_if = "Option::is_none")]
    pub termnl_envt: Option<AttendanceContext1Code>,
    #[serde(rename = "SaleRcncltnId", skip_serializing_if = "Option::is_none")]
    pub sale_rcncltn_id: Option<Max35Text>,
}
#[derive(
...
pub struct DiagnosisRequest1 {
    #[serde(rename = "HstDgnssFlg", skip_serializing_if = "Option::is_none")]
    pub hst_dgnss_flg: Option<TrueFalseIndicator>,
    #[validate(length(min = 0,))]
...
pub struct LogoutRequest1 {
    #[serde(rename = "MntncAllwd", skip_serializing_if = "Option::is_none")]
    pub mntnc_allwd: Option<TrueFalseIndicator>,
}
#[derive(
    Debug,
    Default,
