...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.002.001.04".to_string()
}
...
pub struct PaymentAccount3 {
    ...
    #[serde(rename = "CurBal", skip_serializing_if = "Option::is_none")]
    pub cur_bal: Option<ImpliedCurrencyAndAmount>,
    #[serde(rename = "PmtAcqrrData", skip_serializing_if = "Option::is_none")]
    pub pmt_acqrr_data: Option<Acquirer10>,
}
#[derive(
    Debug,
    Default,
...
pub struct RetailerReversalResult4 {
    #[serde(rename = "POIRcncltnId", skip_serializing_if = "Option::is_none")]
    pub poi_rcncltn_id: Option<Max35Text>,
    #[serde(rename = "OrgnlPmtTx", skip_serializing_if = "Option::is_none")]
    pub orgnl_pmt_tx: Option<CardPaymentTransaction120>,
    #[validate(length(min = 0,))]
    #[serde(rename = "CstmrOrdr", default)]
...
> {
    ...
    #[serde(rename = "PmtRspn", skip_serializing_if = "Option::is_none")]
    pub pmt_rspn: Option<PaymentResponse4>,
    #[serde(rename = "RvslRspn", skip_serializing_if = "Option::is_none")]
    pub rvsl_rspn: Option<ReversalResponse6>,
    #[serde(rename = "BalNqryRspn", skip_serializing_if = "Option::is_none")]
    pub bal_nqry_rspn: Option<BalanceInquiryResponse4>,
    #[serde(rename = "LltyRspn", skip_serializing_if = "Option::is_none")]
    pub llty_rspn: Option<LoyaltyResponse3>,
    #[serde(rename = "StordValRspn", skip_serializing_if = "Option::is_none")]
    pub stord_val_rspn: Option<StoredValueResponse5>,
    #[serde(rename = "BtchRspn", skip_serializing_if = "Option::is_none")]
    pub btch_rspn: Option<BatchResponse4>,
    #[serde(rename = "CardAcqstnRspn", skip_serializing_if = "Option::is_none")]
    pub card_acqstn_rspn: Option<CardAcquisitionResponse3>,
    #[validate]
    #[serde(rename = "Rspn")]
...
pub struct CustomerOrder1 {
    #[validate]
    #[serde(rename = "CstmrOrdrId")]
    pub cstmr_ordr_id: Max35Text,
    #[validate]
    #[serde(rename = "SaleRefId")]
    pub sale_ref_id: Max35Text,
    #[serde(rename = "OpnOrdrStat", skip_serializing_if = "Option::is_none")]
    pub opn_ordr_stat: Option<TrueFalseIndicator>,
    #[validate]
    #[serde(rename = "StartDt")]
    pub start_dt: IsoDateTime,
    #[serde(rename = "EndDt", skip_serializing_if = "Option::is_none")]
    pub end_dt: Option<IsoDateTime>,
    #[serde(rename = "Unit", skip_serializing_if = "Option::is_none")]
    pub unit: Option<AmountUnit1Code>,
    #[validate]
    #[serde(rename = "FrcstdAmt")]
    ...
    #[serde(rename = "Ccy", skip_serializing_if = "Option::is_none")]
    pub ccy: Option<ActiveCurrencyCode>,
    #[serde(rename = "AccsdBy", skip_serializing_if = "Option::is_none")]
    pub accsd_by: Option<Max35Text>,
    #[serde(rename = "AddtlInf", skip_serializing_if = "Option::is_none")]
...
pub struct StoredValueData5 {
    ...
    pub acct_id: Option<StoredValueAccount2>,
    #[serde(rename = "OrgnlPOITx", skip_serializing_if = "Option::is_none")]
    pub orgnl_poi_tx: Option<CardPaymentTransaction120>,
    #[serde(rename = "PdctCd", skip_serializing_if = "Option::is_none")]
    pub pdct_cd: Option<Max35Text>,
    #[serde(rename = "EANUPC", skip_serializing_if = "Option::is_none")]
    pub eanupc: Option<Max35NumericText>,
    #[serde(rename = "ItmAmt", skip_serializing_if = "Option::is_none")]
    pub itm_amt: Option<ImpliedCurrencyAndAmount>,
    #[serde(rename = "Ccy", skip_serializing_if = "Option::is_none")]
    pub ccy: Option<ActiveCurrencyCode>,
    #[serde(rename = "HstTxId", skip_serializing_if = "Option::is_none")]
    pub hst_tx_id: Option<TransactionIdentifier1>,
}
#[derive(
    Debug,
    Default,
...
pub struct CardPaymentToken5 {
    ...
    pub tkn: Option<Min8Max28NumericText>,
...
pub struct LoyaltyResult3 {
    ...
    pub amt: Option<LoyaltyAmount1>,
    #[serde(rename = "SvrData", skip_serializing_if = "Option::is_none")]
    pub svr_data: Option<LoyaltyServerData1>,
    #[serde(rename = "Rbts", skip_serializing_if = "Option::is_none")]
    pub rbts: Option<LoyaltyRebates1>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct LoyaltyServerData1 {
    #[serde(rename = "LltySvrId", skip_serializing_if = "Option::is_none")]
    pub llty_svr_id: Option<Max35Text>,
    #[serde(rename = "ApprvlCd", skip_serializing_if = "Option::is_none")]
    pub apprvl_cd: Option<Min6Max8Text>,
    #[serde(rename = "LltyTxId", skip_serializing_if = "Option::is_none")]
    pub llty_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "HstRcncltnId", skip_serializing_if = "Option::is_none")]
    pub hst_rcncltn_id: Option<Max35Text>,
}
#[derive(
    Debug,
    Default,
...
pub struct LoyaltyRebates1 {
    #[serde(rename = "TtlRbt", skip_serializing_if = "Option::is_none")]
    pub ttl_rbt: Option<ImpliedCurrencyAndAmount>,
    #[serde(rename = "RbtLabl", skip_serializing_if = "Option::is_none")]
    pub rbt_labl: Option<Max35Text>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SaleItmRbt", default)]
...
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
pub enum CardPaymentServiceType14Code {
    #[serde(rename = "IRES")]
    Ires,
    #[serde(rename = "URES")]
    Ures,
...
pub struct CardPaymentTransaction120 {
    #[serde(rename = "TxCaptr", skip_serializing_if = "Option::is_none")]
    pub tx_captr: Option<TrueFalseIndicator>,
    #[serde(rename = "TxTp")]
    pub tx_tp: CardPaymentServiceType5Code,
    #[validate(length(min = 0,))]
    #[serde(rename = "AddtlSvc", default)]
    pub addtl_svc: Vec<CardPaymentServiceType9Code>,
    #[serde(rename = "SvcAttr", skip_serializing_if = "Option::is_none")]
    pub svc_attr: Option<CardPaymentServiceType14Code>,
    #[serde(rename = "LastTxFlg", skip_serializing_if = "Option::is_none")]
    pub last_tx_flg: Option<TrueFalseIndicator>,
    #[serde(rename = "MrchntCtgyCd", skip_serializing_if = "Option::is_none")]
    pub mrchnt_ctgy_cd: Option<Min3Max4Text>,
    ...
    #[serde(rename = "OrgnlTx", skip_serializing_if = "Option::is_none")]
    pub orgnl_tx: Option<CardPaymentTransaction123>,
    #[serde(rename = "RcncltnId", skip_serializing_if = "Option::is_none")]
    pub rcncltn_id: Option<Max35Text>,
    #[serde(rename = "IssrRefData", skip_serializing_if = "Option::is_none")]
    pub issr_ref_data: Option<Max140Text>,
    #[serde(rename = "IssrCITId", skip_serializing_if = "Option::is_none")]
    pub issr_cit_id: Option<Max140Text>,
    #[serde(rename = "MrchntCITId", skip_serializing_if = "Option::is_none")]
    pub mrchnt_cit_id: Option<Max140Text>,
    #[validate]
    #[serde(rename = "TxDtls")]
    pub tx_dtls: CardPaymentTransactionDetails51,
    #[serde(rename = "AuthstnRslt", skip_serializing_if = "Option::is_none")]
    pub authstn_rslt: Option<AuthorisationResult18>,
    #[serde(rename = "MrchntRefData", skip_serializing_if = "Option::is_none")]
    pub mrchnt_ref_data: Option<Max70Text>,
    #[serde(rename = "CstmrOrdr", skip_serializing_if = "Option::is_none")]
    pub cstmr_ordr: Option<CustomerOrder1>,
    #[serde(rename = "CstmrTkn", skip_serializing_if = "Option::is_none")]
    pub cstmr_tkn: Option<CardPaymentToken5>,
    ...
    pub card_prgrmm_apld: Option<Max35Text>,
    #[serde(rename = "SaleToPOIData", skip_serializing_if = "Option::is_none")]
    pub sale_to_poi_data: Option<Max70Text>,
    #[serde(rename = "SaleToAcqrrData", skip_serializing_if = "Option::is_none")]
    pub sale_to_acqrr_data: Option<Max70Text>,
    #[serde(rename = "SaleToIssrData", skip_serializing_if = "Option::is_none")]
    pub sale_to_issr_data: Option<Max70Text>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AddtlTxData", default)]
...
pub struct CardAcquisitionResponse3 {
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[validate]
    #[serde(rename = "POITxId")]
    pub poi_tx_id: TransactionIdentifier1,
    #[validate(length(min = 0,))]
    #[serde(rename = "PmtBrnd", default)]
    pub pmt_brnd: Vec<Max35Text>,
    #[serde(rename = "CstmrLang", skip_serializing_if = "Option::is_none")]
    pub cstmr_lang: Option<LanguageCode>,
    #[validate(length(min = 0,))]
...
pub struct PerformedTransaction4 {
    #[validate]
    #[serde(rename = "Rspn")]
    pub rspn: ResponseType11,
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "POITxId", skip_serializing_if = "Option::is_none")]
    pub poi_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "POIRcncltnId", skip_serializing_if = "Option::is_none")]
    pub poi_rcncltn_id: Option<Max35Text>,
    #[serde(rename = "PmtRslt", skip_serializing_if = "Option::is_none")]
    pub pmt_rslt: Option<RetailerPaymentResult4>,
    #[validate(length(min = 0,))]
    #[serde(rename = "LltyRslt", default)]
    pub llty_rslt: Vec<LoyaltyResult3>,
    #[serde(rename = "RvsdAmt", skip_serializing_if = "Option::is_none")]
    pub rvsd_amt: Option<ImpliedCurrencyAndAmount>,
}
#[derive(
    Debug,
    Default,
...
pub struct ReversalResponse6 {
    ...
    pub issr_ref_data: Option<Max140Text>,
    #[validate]
    #[serde(rename = "RvslTxRslt")]
    pub rvsl_tx_rslt: RetailerReversalResult4,
    #[serde(rename = "RvsdAmt", skip_serializing_if = "Option::is_none")]
    pub rvsd_amt: Option<ImpliedCurrencyAndAmount>,
    #[validate(length(min = 0,))]
    #[serde(rename = "Rct", default)]
    pub rct: Vec<PaymentReceipt4>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct RetailerPaymentResult4 {
    #[serde(rename = "TxTp")]
    ...
    #[serde(rename = "SvcAttr", skip_serializing_if = "Option::is_none")]
    pub svc_attr: Option<CardPaymentServiceType14Code>,
    #[serde(rename = "ReqdTx", skip_serializing_if = "Option::is_none")]
    pub reqd_tx: Option<CardPaymentTransaction120>,
    #[serde(rename = "TxRspn", skip_serializing_if = "Option::is_none")]
    pub tx_rspn: Option<CardPaymentTransaction114>,
    #[validate(length(min = 0,))]
    #[serde(rename = "CstmrOrdr", default)]
    pub cstmr_ordr: Vec<CustomerOrder1>,
    #[serde(rename = "ImgCaptrdSgntr", skip_serializing_if = "Option::is_none")]
    pub img_captrd_sgntr: Option<CapturedSignature1>,
    #[serde(rename = "PrtctdCaptrdSgntr", skip_serializing_if = "Option::is_none")]
    pub prtctd_captrd_sgntr: Option<ContentInformationType32>,
    #[serde(rename = "MrchntOvrrdFlg", skip_serializing_if = "Option::is_none")]
    pub mrchnt_ovrrd_flg: Option<TrueFalseIndicator>,
    #[serde(rename = "CstmrLang", skip_serializing_if = "Option::is_none")]
    pub cstmr_lang: Option<LanguageCode>,
    #[serde(rename = "OnlnFlg", skip_serializing_if = "Option::is_none")]
    pub onln_flg: Option<TrueFalseIndicator>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct BalanceInquiryResponse4 {
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "POITxId", skip_serializing_if = "Option::is_none")]
    pub poi_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "PmtAcct", skip_serializing_if = "Option::is_none")]
    pub pmt_acct: Option<PaymentAccount3>,
    #[serde(rename = "LltyAcct", skip_serializing_if = "Option::is_none")]
    pub llty_acct: Option<LoyaltyAccount3>,
    #[validate(length(min = 0,))]
...
pub struct BatchResponse4 {
    #[serde(rename = "SaleBtchId", skip_serializing_if = "Option::is_none")]
    pub sale_btch_id: Option<TransactionIdentifier1>,
    #[serde(rename = "POIBtchId", skip_serializing_if = "Option::is_none")]
    pub poi_btch_id: Option<TransactionIdentifier1>,
    #[validate(length(min = 0,))]
    #[serde(rename = "PrfrmdTx", default)]
    pub prfrmd_tx: Vec<PerformedTransaction4>,
}
#[derive(
    Debug,
    Default,
...
pub struct CurrencyConversion25 {
    #[serde(rename = "Rslt")]
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "ConvsDtls", default)]
    pub convs_dtls: Vec<CurrencyConversion23>,
}
#[derive(
    Debug,
    Default,
...
pub struct StoredValueResponse5 {
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[validate]
    #[serde(rename = "POITxId")]
...
> {
    #[validate]
    #[serde(rename = "SaleToPOISvcRspn")]
    pub sale_to_poi_svc_rspn: SaleToPoiServiceResponseV04<A>,
...
pub struct PaymentReceipt4 {
    #[serde(rename = "DocQlfr")]
    pub doc_qlfr: DocumentType7Code,
    #[serde(rename = "IntgrtdPrtFlg", skip_serializing_if = "Option::is_none")]
    pub intgrtd_prt_flg: Option<TrueFalseIndicator>,
    #[serde(rename = "ReqrdSgntrFlg", skip_serializing_if = "Option::is_none")]
    pub reqrd_sgntr_flg: Option<TrueFalseIndicator>,
    #[validate]
    #[serde(rename = "OutptCntt")]
    pub outpt_cntt: ActionMessage9,
}
#[derive(
    Debug,
    Default,
...
pub struct SaleToPoiServiceResponseV04<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header41,
    #[validate]
    #[serde(rename = "SvcRspn")]
    pub svc_rspn: ServiceResponse6<A>,
...
pub struct CardPaymentTransaction123 {
    #[serde(rename = "SaleRefId", skip_serializing_if = "Option::is_none")]
    pub sale_ref_id: Option<Max35Text>,
    #[validate]
    #[serde(rename = "TxId")]
    ...
    pub ccy_convs: Option<CurrencyConversion25>,
}
#[derive(
    Debug,
    Default,
...
pub struct PaymentResponse4 {
    ...
    pub issr_ref_data: Option<Max140Text>,
    #[validate]
    #[serde(rename = "RtlrPmtRslt")]
    pub rtlr_pmt_rslt: RetailerPaymentResult4,
    #[validate(length(min = 0,))]
    #[serde(rename = "PmtRct", default)]
    pub pmt_rct: Vec<PaymentReceipt4>,
    #[validate(length(min = 0,))]
    #[serde(rename = "LltyRslt", default)]
    pub llty_rslt: Vec<LoyaltyResult3>,
    #[validate(length(min = 0,))]
