...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.009.001.04".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "SaleToPOIRptReq")]
    pub sale_to_poi_rpt_req: SaleToPoiReportRequestV04<A>,
...
pub struct SaleToPoiReportRequestV04<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
