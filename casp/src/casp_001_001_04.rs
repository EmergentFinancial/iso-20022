...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.001.001.04".to_string()
}
...
pub struct SaleToPoiServiceRequestV04<
...
pub struct BalanceInquiryRequest5 {
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "PmtAcctReq", skip_serializing_if = "Option::is_none")]
    pub pmt_acct_req: Option<PaymentAccountRequest1>,
    #[serde(rename = "LltyAcctReq", skip_serializing_if = "Option::is_none")]
    pub llty_acct_req: Option<LoyaltyAccountRequest3>,
    #[serde(rename = "StordValAcctReq", skip_serializing_if = "Option::is_none")]
    pub stord_val_acct_req: Option<StoredValueRequest5>,
}
#[derive(
    Debug,
    Default,
...
pub struct EnableServiceRequest4 {
    #[serde(rename = "TxActn")]
    pub tx_actn: TransactionAction1Code,
    #[serde(rename = "SvcsNbld", skip_serializing_if = "Option::is_none")]
    pub svcs_nbld: Option<RetailerService2Code>,
...
pub struct TransactionToPerform4ChoiceEnum {
    #[serde(rename = "PmtReq", skip_serializing_if = "Option::is_none")]
    pub pmt_req: Option<PaymentRequest4>,
    #[serde(rename = "LltyReq", skip_serializing_if = "Option::is_none")]
    pub llty_req: Option<LoyaltyRequest4>,
    #[serde(rename = "RvslReq", skip_serializing_if = "Option::is_none")]
    pub rvsl_req: Option<ReversalRequest4>,
}
#[derive(
    Debug,
    Default,
...
pub struct TransactionToPerform4Choice {
    #[serde(flatten)]
    pub value: TransactionToPerform4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct BatchRequest4 {
    #[serde(rename = "SaleBtchId", skip_serializing_if = "Option::is_none")]
    pub sale_btch_id: Option<TransactionIdentifier1>,
    #[serde(rename = "RmvAllFlg", skip_serializing_if = "Option::is_none")]
    pub rmv_all_flg: Option<TrueFalseIndicator>,
    #[validate(length(min = 0,))]
    #[serde(rename = "TxToPrfrm", default)]
    pub tx_to_prfrm: Vec<TransactionToPerform4Choice>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct PaymentAccountRequest1 {
    ...
    #[serde(rename = "AcctRef", skip_serializing_if = "Option::is_none")]
    pub acct_ref: Option<Max35Text>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct LoyaltyAccountRequest3 {
    ...
    pub acct: Option<LoyaltyAccount3>,
}
#[derive(
    Debug,
    Default,
...
pub struct StoredValueRequest5 {
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[validate(length(min = 1,))]
    #[serde(rename = "Data", default)]
    pub data: Vec<StoredValueData5>,
}
#[derive(
    Debug,
    Default,
...
pub struct ReversalRequest4 {
    #[serde(rename = "RvslTx", skip_serializing_if = "Option::is_none")]
    pub rvsl_tx: Option<CardPaymentTransaction120>,
    #[validate(length(min = 0,))]
    #[serde(rename = "LltyData", default)]
    pub llty_data: Vec<LoyaltyRequestData3>,
    #[serde(rename = "RvslRsn")]
...
pub struct LoyaltyTransaction4 {
    #[serde(rename = "SaleTxId", skip_serializing_if = "Option::is_none")]
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[serde(rename = "LltyTxTp")]
...
> {
    ...
    #[serde(rename = "RvslReq", skip_serializing_if = "Option::is_none")]
    pub rvsl_req: Option<ReversalRequest4>,
    #[serde(rename = "BalNqryReq", skip_serializing_if = "Option::is_none")]
    pub bal_nqry_req: Option<BalanceInquiryRequest5>,
    #[serde(rename = "LltyReq", skip_serializing_if = "Option::is_none")]
    pub llty_req: Option<LoyaltyRequest4>,
    #[serde(rename = "StordValReq", skip_serializing_if = "Option::is_none")]
    pub stord_val_req: Option<StoredValueRequest5>,
    #[serde(rename = "BtchReq", skip_serializing_if = "Option::is_none")]
    pub btch_req: Option<BatchRequest4>,
    #[serde(rename = "NblSvcReq", skip_serializing_if = "Option::is_none")]
    pub nbl_svc_req: Option<EnableServiceRequest4>,
    #[serde(rename = "CardAcqstnReq", skip_serializing_if = "Option::is_none")]
    pub card_acqstn_req: Option<CardAcquisitionRequest3>,
    #[validate(length(min = 0,))]
...
pub struct CardAcquisitionRequest3 {
    ...
    pub sale_tx_id: Option<TransactionIdentifier1>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AllwdPmtBrnd", default)]
    pub allwd_pmt_brnd: Vec<Max35Text>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AllwdLltyBrnd", default)]
    pub allwd_llty_brnd: Vec<Max35Text>,
    #[serde(
        rename = "ForceCstmrSelctnFlg",
        skip_serializing_if = "Option::is_none"
    )]
    pub force_cstmr_selctn_flg: Option<TrueFalseIndicator>,
    #[serde(rename = "TtlAmt", skip_serializing_if = "Option::is_none")]
    pub ttl_amt: Option<ImpliedCurrencyAndAmount>,
    #[serde(rename = "PmtTp", skip_serializing_if = "Option::is_none")]
    pub pmt_tp: Option<CardPaymentServiceType13Code>,
    #[serde(rename = "CshBckFlg", skip_serializing_if = "Option::is_none")]
    pub csh_bck_flg: Option<TrueFalseIndicator>,
    #[serde(rename = "SaleToPOIData", skip_serializing_if = "Option::is_none")]
    pub sale_to_poi_data: Option<Max70Text>,
    #[serde(rename = "SaleToAcqrrData", skip_serializing_if = "Option::is_none")]
    pub sale_to_acqrr_data: Option<Max70Text>,
...
pub struct PaymentRequest4 {
    #[serde(rename = "PmtTx", skip_serializing_if = "Option::is_none")]
    pub pmt_tx: Option<CardPaymentTransaction120>,
    #[validate(length(min = 0,))]
    #[serde(rename = "LltyData", default)]
    pub llty_data: Vec<LoyaltyRequestData3>,
}
...
pub struct LoyaltyRequest4 {
    #[serde(rename = "CstmrOrdr", skip_serializing_if = "Option::is_none")]
    pub cstmr_ordr: Option<CustomerOrder1>,
    #[validate]
    #[serde(rename = "Tx")]
    pub tx: LoyaltyTransaction4,
    #[validate(length(min = 0,))]
    #[serde(rename = "Data", default)]
...
> {
    #[validate]
    #[serde(rename = "SaleToPOISvcReq")]
    pub sale_to_poi_svc_req: SaleToPoiServiceRequestV04<A>,
