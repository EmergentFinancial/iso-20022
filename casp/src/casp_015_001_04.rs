...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.015.001.04".to_string()
}
...
pub struct SaleToPoiMessageStatusResponseV04<
...
> {
    ...
    pub hdr: Header41,
    #[validate]
    #[serde(rename = "StsRspn")]
    pub sts_rspn: MessageStatusResponse6<A>,
...
> {
    #[validate]
    #[serde(rename = "SaleToPOIMsgStsRspn")]
    pub sale_to_poi_msg_sts_rspn: SaleToPoiMessageStatusResponseV04<A>,
...
pub struct MessageStatusResponseData6 {
    #[validate]
    #[serde(rename = "XchgId")]
    ...
    #[serde(rename = "RpeatdLltyRspn", skip_serializing_if = "Option::is_none")]
    pub rpeatd_llty_rspn: Option<LoyaltyResponse3>,
    #[serde(rename = "RpeatdPmtRspn", skip_serializing_if = "Option::is_none")]
    pub rpeatd_pmt_rspn: Option<PaymentResponse4>,
    #[serde(rename = "RpeatdRvslRspn", skip_serializing_if = "Option::is_none")]
    pub rpeatd_rvsl_rspn: Option<ReversalResponse6>,
    #[serde(rename = "RpeatdStordValRspn", skip_serializing_if = "Option::is_none")]
    pub rpeatd_stord_val_rspn: Option<StoredValueResponse5>,
    #[serde(
        rename = "RpeatdCardAcqstnRspn",
        skip_serializing_if = "Option::is_none"
    )]
    pub rpeatd_card_acqstn_rspn: Option<CardAcquisitionResponse3>,
    #[serde(
        rename = "RpeatdSndApplPrtcolDataUnitCardRdrRspn",
        skip_serializing_if = "Option::is_none"
    )]
    pub rpeatd_snd_appl_prtcol_data_unit_card_rdr_rspn:
...
pub struct MessageStatusResponse6<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
    ...
    #[validate]
    #[serde(rename = "MsgStsRspnData")]
    pub msg_sts_rspn_data: MessageStatusResponseData6,
    #[validate]
    #[serde(rename = "Rspn")]
