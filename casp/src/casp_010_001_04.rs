...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.010.001.04".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "SaleToPOIRptRspn")]
    pub sale_to_poi_rpt_rspn: SaleToPoiReportResponseV04<A>,
...
pub struct SaleToPoiReportResponseV04<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
