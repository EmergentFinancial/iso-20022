...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:casp.003.001.04".to_string()
}
...
pub struct SaleToPoiReconciliationRequestV04<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    pub rcncltn_req: ReconciliationRequest5<A>,
...
> {
    #[validate]
    #[serde(rename = "SaleToPOIRcncltnReq")]
    pub sale_to_poi_rcncltn_req: SaleToPoiReconciliationRequestV04<A>,
...
pub struct ReconciliationRequest5<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
