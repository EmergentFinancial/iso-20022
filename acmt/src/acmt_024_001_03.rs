...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03".to_string()
}
...
pub struct MessageIdentification7 {
    ...
    pub frst_agt: Option<BranchAndFinancialInstitutionIdentification6>,
}
#[derive(
    Debug,
    Default,
...
pub struct ExternalVerificationReason1Code {
...
pub struct VerificationReport4 {
    ...
    #[serde(rename = "OrgnlPtyAndAcctId", skip_serializing_if = "Option::is_none")]
    pub orgnl_pty_and_acct_id: Option<IdentificationInformation4>,
    #[serde(rename = "UpdtdPtyAndAcctId", skip_serializing_if = "Option::is_none")]
    pub updtd_pty_and_acct_id: Option<IdentificationInformation4>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub id_vrfctn_rpt: IdentificationVerificationReportV03<A>,
...
pub struct IdentificationAssignment3 {
    ...
    #[serde(rename = "Cretr", skip_serializing_if = "Option::is_none")]
    pub cretr: Option<Party40Choice>,
    #[serde(rename = "FrstAgt", skip_serializing_if = "Option::is_none")]
    pub frst_agt: Option<BranchAndFinancialInstitutionIdentification6>,
    #[serde(rename = "Assgnr")]
...
pub struct VerificationReason1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct VerificationReason1Choice {
    #[serde(flatten)]
    pub value: VerificationReason1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct IdentificationVerificationIndicator {
    #[serde(rename = "$text")]
    pub value: bool,
}
#[derive(
...
> {
    ...
    #[serde(rename = "OrgnlAssgnmt", skip_serializing_if = "Option::is_none")]
    pub orgnl_assgnmt: Option<MessageIdentification7>,
