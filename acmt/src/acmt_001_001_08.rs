...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08".to_string()
}
...
pub struct InvestmentAccountOwnershipInformation16 {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "InvstrPrflVldtn", default)]
...
pub struct InvestmentAccount73 {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "InvstrPrfl", default)]
...
pub struct AccountOpeningType1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification47>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct AccountOpeningType1Choice {
    #[serde(flatten)]
    pub value: AccountOpeningType1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct AccountParties12ChoiceEnum {
    ...
    pub jnt_ownr: Option<InvestmentAccountOwnershipInformation16>,
    #[serde(rename = "Trstee", skip_serializing_if = "Option::is_none")]
    pub trstee: Option<InvestmentAccountOwnershipInformation16>,
}
#[derive(
    Debug,
    Default,
...
pub struct AccountParties12Choice {
    #[serde(flatten)]
    pub value: AccountParties12ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
