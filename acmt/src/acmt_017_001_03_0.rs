...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.017.001.03".to_string()
}
...
pub struct Organisation34 {
    #[serde(rename = "FullLglNm", skip_serializing_if = "Option::is_none")]
    pub full_lgl_nm: Option<Max350Text>,
    #[validate]
    #[serde(rename = "OrgId")]
...
> {
    ...
    pub acct_mndt_mntnc_req: AccountMandateMaintenanceRequestV03<A, B>,
