...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.011.001.03".to_string()
}
...
> {
    ...
    pub acct_req_rjctn: AccountRequestRejectionV03<A, B>,
...
pub struct References6 {
    #[serde(rename = "RjctdReqTp")]
    pub rjctd_req_tp: UseCases1Code,
    #[validate(length(min = 1,))]
    #[serde(rename = "RjctnRsn", default)]
    pub rjctn_rsn: Vec<Max350Text>,
    #[validate]
    #[serde(rename = "RjctdReqId")]
