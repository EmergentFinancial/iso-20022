...
::lazy_static::lazy_static! {
    static ref UNLIMITED_9_TEXT_REGEX: ::regex::Regex = ::regex::Regex::new(r#"UNLIMITED"#).unwrap();
}
...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.014.001.04".to_string()
}
...
pub struct FixedAmountOrUnlimited1ChoiceEnum {
...
pub struct FixedAmountOrUnlimited1Choice {
    #[serde(flatten)]
    pub value: FixedAmountOrUnlimited1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Authorisation2 {
    ...
    #[serde(rename = "MaxAmtByPrd", default)]
    pub max_amt_by_prd: Vec<MaximumAmountByPeriod1>,
    #[serde(
        rename = "MaxAmtByBlkSubmissn",
...
pub struct OperationMandate4 {
    ...
    #[serde(rename = "AplblChanl", default)]
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "MndtHldr", default)]
    pub mndt_hldr: Vec<PartyAndAuthorisation4>,
    #[validate(length(min = 1,))]
    #[serde(rename = "BkOpr", default)]
...
pub struct Organisation33 {
    ...
    pub bllg_adr: Option<PostalAddress24>,
    #[validate]
    #[serde(rename = "OrgId")]
    ...
    pub trsr_mgr: Option<PartyIdentification137>,
    #[validate(length(min = 0,))]
...
pub struct PartyOrGroup2ChoiceEnum {
...
pub struct PartyOrGroup2Choice {
    #[serde(flatten)]
    pub value: PartyOrGroup2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Unlimited9Text {
    #[validate(regex = "UNLIMITED_9_TEXT_REGEX")]
    #[serde(rename = "$text")]
    pub value: String,
}
#[derive(
...
pub struct AccountContract3 {
    ...
    pub rmvl_ind: Option<YesNoIndicator>,
}
#[derive(
    Debug,
    Default,
...
pub struct References5 {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "AckdMsgId", default)]
...
> {
    ...
    pub acct_rpt: AccountReportV04<A, B>,
...
pub struct CustomerAccount5 {
    ...
    pub mnthly_pmt_val: Option<ImpliedCurrencyAndAmount>,
    #[serde(rename = "MnthlyRcvdVal", skip_serializing_if = "Option::is_none")]
    pub mnthly_rcvd_val: Option<ImpliedCurrencyAndAmount>,
    ...
    pub avrg_bal: Option<ImpliedCurrencyAndAmount>,
    ...
    pub flr_ntfctn_amt: Option<ImpliedCurrencyAndAmount>,
    #[serde(rename = "ClngNtfctnAmt", skip_serializing_if = "Option::is_none")]
    pub clng_ntfctn_amt: Option<ImpliedCurrencyAndAmount>,
    #[validate(length(min = 0,))]
...
pub struct AccountReport28 {
    ...
    pub trf_acct_svcr_id: Option<BranchAndFinancialInstitutionIdentification6>,
}
#[derive(
    Debug,
    Default,
