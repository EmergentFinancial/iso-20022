...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.027.001.04".to_string()
}
...
pub struct IndividualPersonNameLong2 {
    ...
    #[serde(rename = "Initls", skip_serializing_if = "Option::is_none")]
...
> {
    ...
    pub acct_swtch_inf_req: AccountSwitchInformationRequestV04<A>,
...
pub struct SettlementMethod4ChoiceEnum {
...
pub struct SettlementMethod4Choice {
    #[serde(flatten)]
    pub value: SettlementMethod4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CitizenshipInformation1 {
    ...
    #[serde(rename = "MnrInd", skip_serializing_if = "Option::is_none")]
    pub mnr_ind: Option<YesNoIndicator>,
    #[serde(rename = "StartDt", skip_serializing_if = "Option::is_none")]
    pub start_dt: Option<IsoDate>,
    #[serde(rename = "EndDt", skip_serializing_if = "Option::is_none")]
    pub end_dt: Option<IsoDate>,
...
pub struct IndividualPerson36 {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "CtznshInf", default)]
...
pub struct OtherIdentification1ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct OtherIdentification1Choice {
    #[serde(flatten)]
    pub value: OtherIdentification1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Organisation35 {
    ...
    #[serde(rename = "OrgLglSts", skip_serializing_if = "Option::is_none")]
    pub org_lgl_sts: Option<OrganisationLegalStatus1Code>,
    #[serde(rename = "EstblishdDt", skip_serializing_if = "Option::is_none")]
    pub estblishd_dt: Option<IsoDate>,
    ...
    #[serde(rename = "TaxtnIdNb", skip_serializing_if = "Option::is_none")]
    pub taxtn_id_nb: Option<Max35Text>,
    #[serde(rename = "TaxtnCtry", skip_serializing_if = "Option::is_none")]
    pub taxtn_ctry: Option<CountryCode>,
    #[serde(rename = "CtryOfOpr", skip_serializing_if = "Option::is_none")]
    pub ctry_of_opr: Option<CountryCode>,
    #[serde(rename = "BrdRsltnInd", skip_serializing_if = "Option::is_none")]
    pub brd_rsltn_ind: Option<TrueFalseIndicator>,
    #[serde(rename = "BizAdr", skip_serializing_if = "Option::is_none")]
    pub biz_adr: Option<PostalAddress24>,
    #[serde(rename = "OprlAdr", skip_serializing_if = "Option::is_none")]
    pub oprl_adr: Option<PostalAddress24>,
    #[serde(rename = "LglAdr", skip_serializing_if = "Option::is_none")]
    pub lgl_adr: Option<PostalAddress24>,
    #[validate(length(min = 0,))]
    ...
    pub trsr_mgr: Option<PartyIdentification135>,
    #[validate(length(min = 0,))]
...
pub struct BalanceTransfer4 {
    ...
    pub bal_trf_mtd: Option<SettlementMethod4Choice>,
