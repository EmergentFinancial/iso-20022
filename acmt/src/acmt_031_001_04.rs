...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04".to_string()
}
...
> {
    ...
    pub nmntd_acct: Option<CashAccount41>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub acct_swtch_req_bal_trf: AccountSwitchRequestBalanceTransferV04<A>,
