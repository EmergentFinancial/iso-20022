...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.009.001.03".to_string()
}
...
> {
    ...
    pub acct_opng_addtl_inf_req: AccountOpeningAdditionalInformationRequestV03<A, B>,
