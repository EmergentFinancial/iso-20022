...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06".to_string()
}
...
pub struct OwnerIdentification3ChoiceEnum {
...
pub struct OwnerIdentification3Choice {
    #[serde(flatten)]
    pub value: OwnerIdentification3ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct LinkedMessage5ChoiceEnum {
...
pub struct LinkedMessage5Choice {
    #[serde(flatten)]
    pub value: LinkedMessage5ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct IndividualPersonIdentification2ChoiceEnum {
...
pub struct IndividualPersonIdentification2Choice {
    #[serde(flatten)]
    pub value: IndividualPersonIdentification2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
