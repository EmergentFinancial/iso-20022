...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:secl.002.001.03".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "TradLegNtfctnCxl")]
    pub trad_leg_ntfctn_cxl: TradeLegNotificationCancellationV03<A>,
