...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:catm.001.001.11".to_string()
}
...
pub struct StatusReport11<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "POIId")]
    pub poi_id: GenericIdentification176,
    #[serde(rename = "InitgTrggr", skip_serializing_if = "Option::is_none")]
    pub initg_trggr: Option<TriggerInformation2>,
    #[validate]
    #[serde(rename = "TermnlMgrId")]
    pub termnl_mgr_id: GenericIdentification176,
    #[validate]
    #[serde(rename = "DataSet")]
    pub data_set: StatusReportDataSetRequest3<A>,
}
#[derive(
    Debug,
    Default,
...
pub struct StatusReportDataSetRequest3<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Id")]
    ...
    #[validate]
    #[serde(rename = "Cntt")]
    pub cntt: StatusReportContent11<A>,
}
#[derive(
    Debug,
    Default,
