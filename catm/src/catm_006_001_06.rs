...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:catm.006.001.06".to_string()
}
...
pub struct MaintenanceDelegation14 {
...
pub struct MaintenanceDelegationResponse6 {
    #[validate]
    #[serde(rename = "TMId")]
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "DlgtnRspn", default)]
    pub dlgtn_rspn: Vec<MaintenanceDelegation14>,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[validate]
    #[serde(rename = "MntncDlgtnRspn")]
    pub mntnc_dlgtn_rspn: MaintenanceDelegationResponseV06,
...
pub struct MaintenanceDelegationResponseV06 {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: TmsHeader1,
    #[validate]
    #[serde(rename = "MntncDlgtnRspn")]
    pub mntnc_dlgtn_rspn: MaintenanceDelegationResponse6,
