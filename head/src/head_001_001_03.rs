...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:head.001.001.03".to_string()
}
...
> {
    ...
    pub rltd: Vec<BusinessApplicationHeader7<B>>,
