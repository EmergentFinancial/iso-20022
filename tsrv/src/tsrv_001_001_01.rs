...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsrv.001.001.01".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "UdrtkgIssncDtls")]
    pub udrtkg_issnc_dtls: Undertaking3<A>,
    #[validate(length(min = 0, max = 5,))]
    ...
    pub dgtl_sgntr: Vec<PartyAndSignature2<B>>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "UdrtkgIssnc")]
    pub udrtkg_issnc: UndertakingIssuanceV01<A, B>,
