...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsrv.018.001.01".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "TradStsRpt")]
    pub trad_sts_rpt: TradeStatusReportV01<A>,
