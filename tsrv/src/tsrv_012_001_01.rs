...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsrv.012.001.01".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "UdrtkgTermntnNtfctnDtls")]
    pub udrtkg_termntn_ntfctn_dtls: UndertakingTerminationNotice1<A>,
...
> {
    #[validate]
    #[serde(rename = "UdrtkgTermntnNtfctn")]
    pub udrtkg_termntn_ntfctn: UndertakingTerminationNotificationV01<A, B>,
