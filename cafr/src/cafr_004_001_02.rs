...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cafr.004.001.02".to_string()
}
...
pub struct FraudDispositionResponse2<
...
pub struct FraudDispositionResponseV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: FraudDispositionResponse2<A>,
...
> {
    #[validate]
    #[serde(rename = "FrdDspstnRspn")]
    pub frd_dspstn_rspn: FraudDispositionResponseV02<A>,
