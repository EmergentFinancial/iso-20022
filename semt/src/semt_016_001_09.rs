...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:semt.016.001.09".to_string()
}
...
pub struct IntraPositionMovementPostingReportV09<
...
> {
    ...
    pub fin_instrm: Vec<FinancialInstrumentDetails40<A>>,
}
#[derive(
    Debug,
    Default,
...
pub struct IntraPositionMovementDetails19<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "Id", skip_serializing_if = "Option::is_none")]
    pub id: Option<References72Choice>,
...
pub struct IntraPositionDetails57<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    ...
    pub intra_pos_mvmnt: Vec<IntraPositionMovementDetails19<A>>,
}
#[derive(
    Debug,
    Default,
...
pub struct References72ChoiceEnum {
...
pub struct References72Choice {
    #[serde(flatten)]
    pub value: References72ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub intra_pos_mvmnt_pstng_rpt: IntraPositionMovementPostingReportV09<A>,
...
pub struct FinancialInstrumentDetails40<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    ...
    pub sub_bal: Vec<IntraPositionDetails57<A>>,
}
