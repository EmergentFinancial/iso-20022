...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:semt.019.001.10".to_string()
}
...
pub struct SettlementTransactionCondition17ChoiceEnum {
...
pub struct SettlementTransactionCondition17Choice {
    #[serde(flatten)]
    pub value: SettlementTransactionCondition17ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SettlementDetails168 {
    ...
    pub sttlm_tx_cond: Vec<SettlementTransactionCondition17Choice>,
...
pub struct QuantityAndAccount99 {
...
pub struct SecuritiesTradeDetails137<
...
> {
    ...
    pub sts: Option<AllegementStatus3Choice>,
    ...
    pub qty_and_acct_dtls: QuantityAndAccount99,
    ...
    pub sttlm_params: SettlementDetails168,
...
pub struct SecuritiesSettlementTransactionAllegementReportV10<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Pgntn")]
    ...
    pub allgmt_dtls: Vec<SecuritiesTradeDetails137<A>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub scties_sttlm_tx_allgmt_rpt: SecuritiesSettlementTransactionAllegementReportV10<A>,
...
pub struct AllegementStatus3ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct AllegementStatus3Choice {
    #[serde(flatten)]
    pub value: AllegementStatus3ChoiceEnum,
}
