...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:semt.003.002.11".to_string()
}
...
> {
    ...
    pub bal_for_sub_acct: Vec<AggregateBalanceInformation43<A>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub bal_for_acct: Vec<AggregateBalanceInformation43<A>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SubAcctDtls", default)]
    pub sub_acct_dtls: Vec<SubAccountIdentification68<B>>,
    #[serde(rename = "AcctBaseCcyTtlAmts", skip_serializing_if = "Option::is_none")]
    pub acct_base_ccy_ttl_amts: Option<TotalValueInPageAndStatement4>,
    #[serde(
        rename = "AltrnRptgCcyTtlAmts",
        skip_serializing_if = "Option::is_none"
    )]
    pub altrn_rptg_ccy_ttl_amts: Option<TotalValueInPageAndStatement4>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct AggregateBalancePerSafekeepingPlace40 {
    ...
    pub instrm_ccy_amts: Option<BalanceAmounts5>,
    #[serde(rename = "AltrnRptgCcyAmts", skip_serializing_if = "Option::is_none")]
    pub altrn_rptg_ccy_amts: Option<BalanceAmounts5>,
    #[validate(length(min = 0,))]
...
pub struct BalanceAmounts5 {
    ...
    pub urlsd_gn_loss: Option<AmountAndDirection14>,
...
> {
    ...
    pub scties_bal_acctg_rpt: SecuritiesBalanceAccountingReport002V11<A, B>,
...
> {
    ...
    pub addtl_deriv_attrbts: Option<DerivativeBasicAttributes2>,
    #[validate]
    #[serde(rename = "AggtBal")]
    pub aggt_bal: Balance22,
...
pub struct QuantityBreakdown70 {
    ...
    pub acct_base_ccy_amts: Option<BalanceAmounts6>,
    #[serde(rename = "InstrmCcyAmts", skip_serializing_if = "Option::is_none")]
    pub instrm_ccy_amts: Option<BalanceAmounts6>,
    #[serde(rename = "AltrnRptgCcyAmts", skip_serializing_if = "Option::is_none")]
    pub altrn_rptg_ccy_amts: Option<BalanceAmounts6>,
}
#[derive(
    Debug,
    Default,
