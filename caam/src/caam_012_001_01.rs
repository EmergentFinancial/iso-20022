...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caam.012.001.01".to_string()
}
...
pub struct AtmExceptionAcknowledgementV01 {
    ...
    #[serde(rename = "Hdr")]
    pub hdr: Header32,
    #[serde(rename = "PrtctdATMXcptnAck", skip_serializing_if = "Option::is_none")]
    pub prtctd_atm_xcptn_ack: Option<ContentInformationType10>,
    #[serde(rename = "ATMXcptnAck", skip_serializing_if = "Option::is_none")]
    pub atm_xcptn_ack: Option<AtmExceptionAcknowledgement1>,
