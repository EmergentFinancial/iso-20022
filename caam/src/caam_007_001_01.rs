...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caam.007.001.01".to_string()
}
...
pub struct HostToAtmRequestV01 {
    ...
    #[serde(rename = "Hdr")]
    pub hdr: Header20,
    #[serde(rename = "PrtctdHstToATMReq", skip_serializing_if = "Option::is_none")]
    pub prtctd_hst_to_atm_req: Option<ContentInformationType10>,
    #[serde(rename = "HstToATMReq", skip_serializing_if = "Option::is_none")]
    pub hst_to_atm_req: Option<HostToAtmRequest1>,
