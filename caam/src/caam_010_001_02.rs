...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caam.010.001.02".to_string()
}
...
pub struct AtmReconciliationAcknowledgementV02 {
    ...
    pub hdr: Header32,
    #[serde(
        rename = "PrtctdATMRcncltnAck",
        skip_serializing_if = "Option::is_none"
    )]
    pub prtctd_atm_rcncltn_ack: Option<ContentInformationType10>,
    #[serde(rename = "ATMRcncltnAck", skip_serializing_if = "Option::is_none")]
    pub atm_rcncltn_ack: Option<AtmReconciliationAcknowledgement2>,
