...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caam.005.001.02".to_string()
}
...
pub struct AtmDiagnosticRequestV02 {
    ...
    #[serde(rename = "Hdr")]
    pub hdr: Header31,
    #[serde(rename = "PrtctdATMDgnstcReq", skip_serializing_if = "Option::is_none")]
    pub prtctd_atm_dgnstc_req: Option<ContentInformationType10>,
    #[serde(rename = "ATMDgnstcReq", skip_serializing_if = "Option::is_none")]
    pub atm_dgnstc_req: Option<AtmDiagnosticRequest2>,
