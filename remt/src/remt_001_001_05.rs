...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:remt.001.001.05".to_string()
}
...
> {
    ...
    pub rmt_advc: RemittanceAdviceV05<A>,
...
pub struct AmountType3ChoiceEnum {
...
pub struct AmountType3Choice {
    #[serde(flatten)]
    pub value: AmountType3ChoiceEnum,
}
#[derive(
    Debug,
    Default,
