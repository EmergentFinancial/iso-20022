...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.029.001.01".to_string()
}
...
pub struct ProcessingStatus72ChoiceEnum {
...
pub struct ProcessingStatus72Choice {
    #[serde(flatten)]
    pub value: ProcessingStatus72ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub scty_mntnc_sts_advc: SecurityMaintenanceStatusAdviceV01<A>,
...
pub struct Reason18ChoiceEnum {
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<ProprietaryReason4>,
