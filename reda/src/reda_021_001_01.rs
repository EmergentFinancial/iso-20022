...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.021.001.01".to_string()
}
...
pub struct SecuritiesAccountOrOperationalError3ChoiceEnum {
    #[serde(rename = "SctiesAcctRpt", skip_serializing_if = "Option::is_none")]
    pub scties_acct_rpt: Option<SecuritiesAccountReport3>,
...
pub struct SecuritiesAccountOrOperationalError3Choice {
    #[serde(flatten)]
    pub value: SecuritiesAccountOrOperationalError3ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub scties_acct_rpt: SecuritiesAccountReportV01<A>,
...
pub struct SecuritiesAccountOrBusinessError3ChoiceEnum {
...
pub struct SecuritiesAccountOrBusinessError3Choice {
    #[serde(flatten)]
    pub value: SecuritiesAccountOrBusinessError3ChoiceEnum,
}
#[derive(
    Debug,
    Default,
