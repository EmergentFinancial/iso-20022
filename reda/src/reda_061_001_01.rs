...
::lazy_static::lazy_static! {
    static ref DATE_OFFSET_TEXT_REGEX: ::regex::Regex = ::regex::Regex::new(r#"0|-1|-2"#).unwrap();
}

/// Returns the namespace of the schema
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.061.001.01".to_string()
}
...
pub struct NettingCutOff1 {
    ...
    #[serde(rename = "NewCutOff", default)]
...
pub struct NettingIdentification1ChoiceEnum {
...
pub struct NettingIdentification1Choice {
    #[serde(flatten)]
    pub value: NettingIdentification1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub netg_cut_off_ref_data_rpt: NettingCutOffReferenceDataReportV01<A>,
...
pub struct CutOffData1 {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "NetgCutOffDtls", default)]
...
pub struct NettingCutOffReportData1 {
    ...
    pub net_svc_ptcpt_id: Option<PartyIdentification73Choice>,
    #[serde(rename = "RptSvcr", skip_serializing_if = "Option::is_none")]
    pub rpt_svcr: Option<PartyIdentification73Choice>,
...
> {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "PtcptNetgCutOffData", default)]
...
pub struct DateOffsetText {
    #[validate(regex = "DATE_OFFSET_TEXT_REGEX")]
    #[serde(rename = "$text")]
    pub value: String,
}
