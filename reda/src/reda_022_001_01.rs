...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.022.001.01".to_string()
}
...
> {
    ...
    pub pty_mod_req: PartyModificationRequestV01<A>,
...
> {
    ...
    pub r#mod: Vec<SystemPartyModification2>,
    #[validate(length(min = 0,))]
...
pub struct SystemPartyModification2ChoiceEnum {
    #[serde(rename = "ResTp", skip_serializing_if = "Option::is_none")]
    pub res_tp: Option<ResidenceType1Code>,
    #[serde(rename = "PtyAdr", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "SysPtyDt", skip_serializing_if = "Option::is_none")]
...
pub struct SystemPartyModification2Choice {
    #[serde(flatten)]
    pub value: SystemPartyModification2ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
