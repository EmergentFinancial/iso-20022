...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.005.001.03".to_string()
}
...
pub struct FundParameters4ChoiceEnum {
...
pub struct FundParameters4Choice {
    #[serde(flatten)]
    pub value: FundParameters4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
