...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.056.001.01".to_string()
}
...
> {
    ...
    pub stg_sttlm_instr: StandingSettlementInstructionV01<A>,
...
pub struct SettlementParties32 {
    ...
    pub pty_1: Option<PartyIdentificationAndAccount95>,
    #[serde(rename = "Pty2", skip_serializing_if = "Option::is_none")]
    pub pty_2: Option<PartyIdentificationAndAccount95>,
    #[serde(rename = "Pty3", skip_serializing_if = "Option::is_none")]
    pub pty_3: Option<PartyIdentificationAndAccount95>,
    #[serde(rename = "Pty4", skip_serializing_if = "Option::is_none")]
    pub pty_4: Option<PartyIdentificationAndAccount95>,
    #[serde(rename = "Pty5", skip_serializing_if = "Option::is_none")]
    pub pty_5: Option<PartyIdentificationAndAccount95>,
}
#[derive(
    Debug,
    Default,
...
pub struct CashParties24 {
    ...
    pub intrmy_2: Option<PartyIdentificationAndAccount97>,
}
#[derive(
    Debug,
    Default,
...
pub struct PartyIdentification99ChoiceEnum {
    #[serde(rename = "NmAndAdr", skip_serializing_if = "Option::is_none")]
...
pub struct PartyIdentification99Choice {
    #[serde(flatten)]
    pub value: PartyIdentification99ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SecuritiesOrCash1ChoiceEnum {
...
pub struct SecuritiesOrCash1Choice {
    #[serde(flatten)]
    pub value: SecuritiesOrCash1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
