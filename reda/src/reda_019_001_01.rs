...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.019.001.01".to_string()
}
...
pub struct SecuritiesAccountReturnCriteria1 {
    ...
    pub acct_id: Option<RequestedIndicator>,
    ...
    pub pty_tp: Option<RequestedIndicator>,
    #[serde(rename = "AcctSvcr", skip_serializing_if = "Option::is_none")]
    pub acct_svcr: Option<RequestedIndicator>,
    #[serde(rename = "AcctTp", skip_serializing_if = "Option::is_none")]
    pub acct_tp: Option<RequestedIndicator>,
    ...
    pub end_invstr_flg: Option<RequestedIndicator>,
    #[serde(rename = "PricgSchme", skip_serializing_if = "Option::is_none")]
    pub pricg_schme: Option<RequestedIndicator>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub scties_acct_qry: SecuritiesAccountQueryV01<A>,
...
pub struct SystemSecuritiesAccountType1ChoiceEnum {
...
pub struct SystemSecuritiesAccountType1Choice {
    #[serde(flatten)]
    pub value: SystemSecuritiesAccountType1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
