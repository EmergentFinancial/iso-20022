...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:reda.060.001.01".to_string()
}
...
> {
    ...
    pub netg_cut_off_ref_data_upd_req: NettingCutOffReferenceDataUpdateRequestV01<A>,
...
> {
    ...
    #[serde(rename = "NetgCutOffReq", default)]
...
pub struct RequestData1 {
    ...
    pub req_svcr: Option<PartyIdentification73Choice>,
