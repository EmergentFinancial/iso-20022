...
#[cfg(feature = "ecdsa")]
impl MessageSigner<crate::documents::Document, ecdsa::EcdsaSignature, ecdsa::EcdsaSigner> {
    /// Create a random P256 Signer
    #[cfg(feature = "p256")]
    pub fn random_p256(
    ) -> MessageSigner<crate::documents::Document, ecdsa::EcdsaSignature, ecdsa::EcdsaSigner> {
