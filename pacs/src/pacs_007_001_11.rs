...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.11".to_string()
}
...
> {
    ...
    pub orgnl_grp_inf: Option<OriginalGroupHeader16>,
    #[validate(length(min = 0,))]
    #[serde(rename = "TxInf", default)]
    pub tx_inf: Vec<PaymentTransaction135<A>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub fi_to_fi_pmt_rvsl: FiToFiPaymentReversalV11<A, B>,
