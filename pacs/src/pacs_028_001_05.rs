...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.05".to_string()
}
...
> {
    ...
    pub fi_to_fi_pmt_sts_req: FiToFiPaymentStatusRequestV05<A, B>,
