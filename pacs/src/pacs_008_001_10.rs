...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10".to_string()
}
...
> {
    ...
    pub cdt_trf_tx_inf: Vec<CreditTransferTransaction50<A>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub fi_to_fi_cstmr_cdt_trf: FiToFiCustomerCreditTransferV10<A, B>,
