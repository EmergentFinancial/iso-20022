...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05".to_string()
}
...
pub struct FullPushThroughReportV05 {
    ...
    #[validate]
    #[serde(rename = "RptPurp")]
    pub rpt_purp: ReportType1,
    #[validate]
    #[serde(rename = "PushdThrghBaseln")]
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "BuyrBkCtctPrsn", default)]
    pub buyr_bk_ctct_prsn: Vec<ContactIdentification1>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SellrBkCtctPrsn", default)]
