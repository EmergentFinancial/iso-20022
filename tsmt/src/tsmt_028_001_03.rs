...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsmt.028.001.03".to_string()
}
...
pub struct StatusChangeRequestNotificationV03 {
    ...
    #[validate]
    #[serde(rename = "PropsdStsChng")]
    pub propsd_sts_chng: TransactionStatus3,
    #[serde(rename = "ReqRsn", skip_serializing_if = "Option::is_none")]
    pub req_rsn: Option<Reason2>,
    #[validate]
    #[serde(rename = "Initr")]
