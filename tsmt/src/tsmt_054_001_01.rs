...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "InvcPmtRcncltnSts")]
    pub invc_pmt_rcncltn_sts: InvoicePaymentReconciliationStatusV01<A, B, C, D>,
