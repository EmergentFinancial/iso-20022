...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:colr.011.001.05".to_string()
}
...
pub struct SubstitutionResponse2 {
    ...
    #[serde(
        rename = "CollSbstitnAccptncDtls",
        skip_serializing_if = "Option::is_none"
    )]
    pub coll_sbstitn_accptnc_dtls: Option<CollateralSubstitutionResponse1>,
    #[serde(
        rename = "CollSbstitnRjctnDtls",
        skip_serializing_if = "Option::is_none"
    )]
    pub coll_sbstitn_rjctn_dtls: Option<CollateralSubstitutionResponse3>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "CollSbstitnRspn")]
    pub coll_sbstitn_rspn: CollateralSubstitutionResponseV05<A>,
...
pub struct CollateralSubstitutionResponse3 {
    ...
    pub coll_sbstitn_req_id: Max35Text,
    #[validate]
    #[serde(rename = "RjctdAmt")]
    pub rjctd_amt: ActiveCurrencyAndAmount,
    #[serde(rename = "RjctnRsn")]
    pub rjctn_rsn: RejectionReason68Code,
    #[serde(rename = "RjctnRsnInf", skip_serializing_if = "Option::is_none")]
    pub rjctn_rsn_inf: Option<Max140Text>,
}
#[derive(
    Debug,
    Default,
