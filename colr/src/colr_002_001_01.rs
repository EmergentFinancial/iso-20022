...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:colr.002.001.01".to_string()
}
...
pub struct CollateralValuePosition3 {
    #[validate]
    #[serde(rename = "DataAccsTm")]
    pub data_accs_tm: IsoDateTime,
    #[serde(rename = "TtlCollValtn", skip_serializing_if = "Option::is_none")]
    pub ttl_coll_valtn: Option<ActiveCurrencyAndAmount>,
    #[serde(rename = "SctiesAcct", skip_serializing_if = "Option::is_none")]
    pub scties_acct: Option<SecuritiesAccount19>,
    #[validate(length(min = 0,))]
    #[serde(rename = "Scties", default)]
...
pub struct CollateralValueReportOrError6ChoiceEnum {
...
pub struct CollateralValueReportOrError6Choice {
    #[serde(flatten)]
    pub value: CollateralValueReportOrError6ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CollateralValueReportOrError5ChoiceEnum {
    ...
    pub biz_rpt: Option<CollateralValueReport3>,
}
#[derive(
    Debug,
    Default,
...
pub struct CollateralValueReportOrError5Choice {
    #[serde(flatten)]
    pub value: CollateralValueReportOrError5ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CollateralValueReport3 {
    ...
    pub csh_acct_ownr: Option<SystemPartyIdentification11>,
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "CollValRpt", default)]
...
> {
    #[validate]
    #[serde(rename = "CollValRpt")]
    pub coll_val_rpt: CollateralValueReportV01<A>,
...
pub struct SubBalanceQuantity2ChoiceEnum {
...
pub struct SubBalanceQuantity2Choice {
    #[serde(flatten)]
    pub value: SubBalanceQuantity2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
