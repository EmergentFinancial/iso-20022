...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:colr.021.001.01".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "TrptyCollAllgmtNtfctn")]
    pub trpty_coll_allgmt_ntfctn: TripartyCollateralAllegementNotificationV01<A>,
...
pub struct DealTransactionDetails6 {
    ...
    pub deal_dtls_amt: Option<CollateralAmount12>,
