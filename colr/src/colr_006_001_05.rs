...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:colr.006.001.05".to_string()
}
...
pub struct CollateralCancellationStatus2 {
    #[serde(rename = "CollStsCd")]
    pub coll_sts_cd: Status4Code,
    #[serde(rename = "AddtlInf", skip_serializing_if = "Option::is_none")]
    pub addtl_inf: Option<Max35Text>,
    #[serde(rename = "RjctnDtls", skip_serializing_if = "Option::is_none")]
    pub rjctn_dtls: Option<RejectionStatus3>,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "CollMgmtCxlSts")]
    pub coll_mgmt_cxl_sts: CollateralManagementCancellationStatusV05<A>,
