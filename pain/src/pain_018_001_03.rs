...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.018.001.03".to_string()
}
...
> {
    ...
    #[serde(rename = "UndrlygSspnsnDtls", default)]
    pub undrlyg_sspnsn_dtls: Vec<MandateSuspension3<A>>,
...
> {
    ...
    pub mndt_sspnsn_req: MandateSuspensionRequestV03<A, B>,
...
pub struct ExternalMandateSuspensionReason1Code {
    #[validate(length(min = 1, max = 4,))]
    #[serde(rename = "$text")]
    pub value: String,
}
...
pub struct MandateSuspensionReason1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct MandateSuspensionReason1Choice {
    #[serde(flatten)]
    pub value: MandateSuspensionReason1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct OriginalMandate9ChoiceEnum {
...
pub struct OriginalMandate9Choice {
    #[serde(flatten)]
    pub value: OriginalMandate9ChoiceEnum,
}
#[derive(
    Debug,
    Default,
