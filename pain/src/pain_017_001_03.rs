...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.017.001.03".to_string()
}
...
pub struct MandateStatus1ChoiceEnum {
...
pub struct MandateStatus1Choice {
    #[serde(flatten)]
    pub value: MandateStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub mndt_cpy_req: MandateCopyRequestV03<A, B>,
...
> {
    ...
    #[serde(rename = "UndrlygCpyReqDtls", default)]
    pub undrlyg_cpy_req_dtls: Vec<MandateCopy3<A>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    #[serde(rename = "MndtSts", skip_serializing_if = "Option::is_none")]
