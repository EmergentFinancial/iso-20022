...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.002.001.12".to_string()
}
...
> {
    ...
    pub tx_inf_and_sts: Vec<PaymentTransaction129<A>>,
}
#[derive(
    Debug,
    Default,
...
pub struct TrackerData1 {
    ...
    #[serde(rename = "TrckrRcrd", default)]
...
> {
    ...
    pub orgnl_pmt_inf_and_sts: Vec<OriginalPaymentInstruction40<A>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
...
> {
    ...
    pub cstmr_pmt_sts_rpt: CustomerPaymentStatusReportV12<A, B>,
