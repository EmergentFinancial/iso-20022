...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.007.001.11".to_string()
}
...
pub struct GroupHeader88 {
    ...
    pub grp_rvsl: Option<TrueFalseIndicator>,
...
pub struct ReversalReason4ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct ReversalReason4Choice {
    #[serde(flatten)]
    pub value: ReversalReason4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct OriginalPaymentInstruction41<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "RvslPmtInfId", skip_serializing_if = "Option::is_none")]
    pub rvsl_pmt_inf_id: Option<Max35Text>,
    #[validate]
    ...
    #[serde(rename = "PmtInfRvsl", skip_serializing_if = "Option::is_none")]
    pub pmt_inf_rvsl: Option<TrueFalseIndicator>,
    #[validate(length(min = 0,))]
    #[serde(rename = "RvslRsnInf", default)]
    pub rvsl_rsn_inf: Vec<PaymentReversalReason9>,
    #[validate(length(min = 0,))]
    #[serde(rename = "TxInf", default)]
    pub tx_inf: Vec<PaymentTransaction134<A>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub cstmr_pmt_rvsl: CustomerPaymentReversalV11<A, B>,
...
> {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "OrgnlPmtInfAndRvsl", default)]
    pub orgnl_pmt_inf_and_rvsl: Vec<OriginalPaymentInstruction41<A>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
