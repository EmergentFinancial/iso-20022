...
::lazy_static::lazy_static! {
    static ref MAX_10_MB_BINARY_REGEX: ::regex::Regex = ::regex::Regex::new(r#"[A-Za-z0-9+/]{4}*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?"#).unwrap();
}
...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.014.001.10".to_string()
}
...
pub struct Max10MbBinary {
    #[validate(length(min = 1, max = 10485760,), regex = "MAX_10_MB_BINARY_REGEX")]
    pub value: String,
}
#[derive(
    Debug,
...
pub struct CreditorPaymentActivationRequestStatusReportV10<
...
> {
    ...
    pub orgnl_pmt_inf_and_sts: Vec<OriginalPaymentInstruction46<A, B, C>>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub cdtr_pmt_actvtn_req_sts_rpt: CreditorPaymentActivationRequestStatusReportV10<A, B, C, D>,
...
pub struct PaymentTransaction145<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    ...
    pub chrgs_inf: Vec<Charges12>,
    #[serde(rename = "DbtrDcsnDtTm", skip_serializing_if = "Option::is_none")]
    pub dbtr_dcsn_dt_tm: Option<IsoDateTime>,
    ...
    pub orgnl_tx_ref: Option<OriginalTransactionReference38<A>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "NclsdFile", default)]
    pub nclsd_file: Vec<Document12<B>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
...
pub struct OriginalPaymentInstruction46<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    C: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    ...
    pub tx_inf_and_sts: Vec<PaymentTransaction145<A, B, C>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub dgtl_sgntr: Option<PartyAndSignature3<A>>,
    #[validate]
    #[serde(rename = "Nclsr")]
...
pub struct DocumentType1ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct DocumentType1Choice {
    #[serde(flatten)]
    pub value: DocumentType1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct OriginalTransactionReference38<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "NclsdFile", default)]
    pub nclsd_file: Vec<Document12<A>>,
    #[serde(rename = "UltmtDbtr", skip_serializing_if = "Option::is_none")]
