...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.013.001.10".to_string()
}
...
pub struct PaymentInstruction42<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    ...
    #[serde(rename = "CdtTrfTx", default)]
    pub cdt_trf_tx: Vec<CreditTransferTransaction57<A, B>>,
}
#[derive(
    Debug,
    Default,
...
pub struct CreditorPaymentActivationRequestV10<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
...
> {
    #[validate]
    #[serde(rename = "GrpHdr")]
    pub grp_hdr: GroupHeader105,
    #[validate(length(min = 1,))]
    #[serde(rename = "PmtInf", default)]
    pub pmt_inf: Vec<PaymentInstruction42<A, B>>,
    #[validate(length(min = 0,))]
...
pub struct AdviceType1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<Max35Text>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct AdviceType1Choice {
    #[serde(flatten)]
    pub value: AdviceType1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CreditTransferTransaction57<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
    B: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
...
> {
    ...
    pub cdtr_pmt_actvtn_req: CreditorPaymentActivationRequestV10<A, B, C>,
