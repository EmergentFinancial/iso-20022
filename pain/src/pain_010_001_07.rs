...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.010.001.07".to_string()
}
...
> {
    ...
    pub mndt_amdmnt_req: MandateAmendmentRequestV07<A, B>,
...
> {
    ...
    #[serde(rename = "UndrlygAmdmntDtls", default)]
    pub undrlyg_amdmnt_dtls: Vec<MandateAmendment7<A>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
