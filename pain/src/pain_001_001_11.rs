...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11".to_string()
}
...
> {
    ...
    pub cdt_trf_tx_inf: Vec<CreditTransferTransaction54<A>>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub cstmr_cdt_trf_initn: CustomerCreditTransferInitiationV11<A, B>,
...
> {
    ...
    pub pmt_inf: Vec<PaymentInstruction40<A>>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SplmtryData", default)]
