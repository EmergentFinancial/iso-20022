...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:admi.005.001.01".to_string()
}
...
> {
    ...
    pub rpt_qry_req: ReportQueryRequestV01<A>,
...
pub struct ReportQuerySearchCriteria2 {
    ...
    pub rpt_nm: Option<Max4AlphaNumericText>,
    #[serde(rename = "MsgNmId", skip_serializing_if = "Option::is_none")]
    pub msg_nm_id: Option<Max35Text>,
    #[validate]
    #[serde(rename = "PtyId")]
...
> {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "RptQryCrit", default)]
