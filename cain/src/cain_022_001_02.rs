...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cain.022.001.02".to_string()
}
...
pub struct RetrievalResponseV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
...
> {
    #[validate]
    #[serde(rename = "RtrvlRspn")]
    pub rtrvl_rspn: RetrievalResponseV02<A>,
