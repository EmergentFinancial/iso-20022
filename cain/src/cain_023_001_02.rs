...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cain.023.001.02".to_string()
}
...
pub struct CardManagementInitiation2<
...
> {
    #[validate]
    #[serde(rename = "CardMgmtInitn")]
    pub card_mgmt_initn: CardManagementInitiationV02<A>,
...
pub struct CardManagementInitiationV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: CardManagementInitiation2<A>,
...
pub struct Transaction152 {
    ...
    #[serde(rename = "NewPINData", skip_serializing_if = "Option::is_none")]
    pub new_pin_data: Option<PinData1>,
