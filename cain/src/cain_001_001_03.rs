...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cain.001.001.03".to_string()
}
...
pub struct AuthorisationInitiationV03<
...
> {
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: AuthorisationInitiation2<A>,
...
> {
    #[validate]
    #[serde(rename = "AuthstnInitn")]
    pub authstn_initn: AuthorisationInitiationV03<A>,
...
pub struct AuthorisationInitiation2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
