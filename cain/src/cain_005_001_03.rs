...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cain.005.001.03".to_string()
}
...
pub struct PartyIdentification253 {
    #[validate]
    #[serde(rename = "Id")]
    pub id: Max35Text,
...
> {
    #[validate]
    #[serde(rename = "RvslInitn")]
    pub rvsl_initn: ReversalInitiationV03<A>,
...
pub struct Context14 {
    ...
    pub tx_cntxt: Option<TransactionContext9>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct TransactionContext9 {
...
pub struct ReversalInitiation2<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
    pub envt: Environment19,
    #[serde(rename = "Cntxt", skip_serializing_if = "Option::is_none")]
    pub cntxt: Option<Context14>,
    #[validate]
    #[serde(rename = "Tx")]
    pub tx: Transaction142,
...
pub struct ReversalInitiationV03<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: ReversalInitiation2<A>,
...
pub struct Environment19 {
    ...
    pub accptr: Option<PartyIdentification253>,
    #[serde(rename = "Dstn", skip_serializing_if = "Option::is_none")]
