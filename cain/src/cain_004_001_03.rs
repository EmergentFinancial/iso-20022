...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cain.004.001.03".to_string()
}
...
pub struct FinancialResponseV03<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
...
> {
    #[validate]
    #[serde(rename = "FinRspn")]
    pub fin_rspn: FinancialResponseV03<A>,
