...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:cain.021.001.02".to_string()
}
...
pub struct Header67 {
    ...
    pub msg_fctn: MessageFunction45Code,
    #[validate]
...
pub struct RetrievalInitiation2<
...
> {
    ...
    #[serde(rename = "RtrvlFlfmtDstn", skip_serializing_if = "Option::is_none")]
    pub rtrvl_flfmt_dstn: Option<PartyIdentification258>,
    #[validate(length(min = 0,))]
...
> {
    #[validate]
    #[serde(rename = "RtrvlInitn")]
    pub rtrvl_initn: RetrievalInitiationV02<A>,
...
pub struct RetrievalInitiationV02<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    ...
    #[validate]
    #[serde(rename = "Body")]
    pub body: RetrievalInitiation2<A>,
...
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
pub enum MessageFunction45Code {
    #[serde(rename = "ADVC")]
    Advc,
    #[serde(rename = "INST")]
    Inst,
