...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.040.002.11".to_string()
}
...
pub struct CorporateActionGeneralInformation159 {
    ...
    pub fin_instrm_id: Option<SecurityIdentification21>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub corp_actn_instr_cxl_req: CorporateActionInstructionCancellationRequest002V11<A>,
...
pub struct AccountIdentification62 {
    ...
    pub sfkpg_plc: Option<SafekeepingPlaceFormat34Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct SafekeepingPlaceFormat34ChoiceEnum {
...
pub struct SafekeepingPlaceFormat34Choice {
    #[serde(flatten)]
    pub value: SafekeepingPlaceFormat34ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct CorporateActionInstructionCancellationRequest002V11<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    ...
    pub acct_dtls: AccountIdentification62,
    #[validate]
    ...
    pub prtct_instr: Option<ProtectInstruction7>,
    #[validate(length(min = 0,))]
