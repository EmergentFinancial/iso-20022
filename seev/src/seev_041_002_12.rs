...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.041.002.12".to_string()
}
...
pub struct PendingCancellationStatus8Choice {
    #[serde(flatten)]
    pub value: PendingCancellationStatus8ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CorporateActionOption201 {
    #[serde(rename = "OptnNb")]
    ...
    pub prtct_bal: Option<SignedQuantityFormat12>,
...
pub struct CorporateActionInstructionCancellationRequestStatusAdvice002V12<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "InstrCxlReqId", skip_serializing_if = "Option::is_none")]
    pub instr_cxl_req_id: Option<DocumentIdentification17>,
    #[validate(length(min = 0,))]
    ...
    pub instr_cxl_req_sts: Vec<InstructionCancellationRequestStatus14Choice>,
    #[serde(rename = "CorpActnInstr", skip_serializing_if = "Option::is_none")]
    pub corp_actn_instr: Option<CorporateActionOption201>,
    #[serde(rename = "PrtctInstr", skip_serializing_if = "Option::is_none")]
    pub prtct_instr: Option<ProtectInstruction8>,
...
> {
    ...
    pub corp_actn_instr_cxl_req_sts_advc:
        CorporateActionInstructionCancellationRequestStatusAdvice002V12<A>,
...
pub struct CancelledReason10ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct CancelledReason10Choice {
    #[serde(flatten)]
    pub value: CancelledReason10ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectedStatusReason45 {
    #[serde(rename = "RsnCd")]
    pub rsn_cd: RejectedReason48Choice,
    #[serde(rename = "AddtlRsnInf", skip_serializing_if = "Option::is_none")]
    pub addtl_rsn_inf: Option<RestrictedFinxMax210Text>,
}
#[derive(
...
pub struct RejectedReason48ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification47>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct RejectedReason48Choice {
    #[serde(flatten)]
    pub value: RejectedReason48ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectedStatus47ChoiceEnum {
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<RejectedStatusReason45>,
...
pub struct RejectedStatus47Choice {
    #[serde(flatten)]
    pub value: RejectedStatus47ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CancelledStatus14ChoiceEnum {
    #[serde(rename = "NoSpcfdRsn", skip_serializing_if = "Option::is_none")]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<CancelledStatusReason13>,
}
#[derive(
    Debug,
    Default,
...
pub struct CancelledStatus14Choice {
    #[serde(flatten)]
    pub value: CancelledStatus14ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct InstructionCancellationRequestStatus14ChoiceEnum {
    ...
    pub rjctd: Option<RejectedStatus47Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct InstructionCancellationRequestStatus14Choice {
    #[serde(flatten)]
    pub value: InstructionCancellationRequestStatus14ChoiceEnum,
}
#[derive(
    Debug,
    Default,
