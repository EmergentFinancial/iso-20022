...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.015.001.01".to_string()
}
...
pub struct RejectionReason9FormatChoiceEnum {
...
pub struct RejectionReason9FormatChoice {
    #[serde(flatten)]
    pub value: RejectionReason9FormatChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ElectionAdviceStatus1ChoiceEnum {
...
pub struct ElectionAdviceStatus1Choice {
    #[serde(flatten)]
    pub value: ElectionAdviceStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectionReason8FormatChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct RejectionReason8FormatChoice {
    #[serde(flatten)]
    pub value: RejectionReason8FormatChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct AgentCaElectionStatusAdviceV01Enum {
    #[serde(rename = "ElctnAdvcSts", skip_serializing_if = "Option::is_none")]
    pub elctn_advc_sts: Option<ElectionAdviceStatus1Choice>,
    #[serde(rename = "ElctnCxlReqSts", skip_serializing_if = "Option::is_none")]
    pub elctn_cxl_req_sts: Option<ElectionCancellationStatus1Choice>,
    #[serde(rename = "ElctnAmdmntReqSts", skip_serializing_if = "Option::is_none")]
...
pub struct AgentCaElectionStatusAdviceV01 {
    #[serde(flatten)]
    pub value: AgentCaElectionStatusAdviceV01Enum,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[serde(rename = "AgtCAElctnStsAdvc")]
...
pub struct ElectionAmendmentStatus1ChoiceEnum {
    #[serde(rename = "PrcdSts", skip_serializing_if = "Option::is_none")]
...
pub struct ElectionAmendmentStatus1Choice {
    #[serde(flatten)]
    pub value: ElectionAmendmentStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ElectionCancellationStatus1ChoiceEnum {
    #[serde(rename = "RjctdSts", skip_serializing_if = "Option::is_none")]
...
pub struct ElectionCancellationStatus1Choice {
    #[serde(flatten)]
    pub value: ElectionCancellationStatus1ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct RejectionReason18FormatChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct RejectionReason18FormatChoice {
    #[serde(flatten)]
    pub value: RejectionReason18FormatChoiceEnum,
}
#[derive(
    Debug,
    Default,
