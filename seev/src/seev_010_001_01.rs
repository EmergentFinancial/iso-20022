...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.010.001.01".to_string()
}
...
pub struct AgentCaNotificationCancellationRequestV01 {
    ...
    #[validate]
    #[serde(rename = "NtfctnCxlTpAndLkg")]
    ...
    #[serde(rename = "CorpActnNtfctnDtls", skip_serializing_if = "Option::is_none")]
    pub corp_actn_ntfctn_dtls: Option<CorporateActionNotificationAdvice1>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct NotificationCancellation1 {
    #[serde(rename = "NtfctnCxlTp")]
    pub ntfctn_cxl_tp: CorporateActionNotificationType2Code,
    #[validate]
    #[serde(rename = "LkdAgtCANtfctnAdvcId")]
...
pub struct Document {
    #[serde(rename = "AgtCANtfctnCxlReq")]
