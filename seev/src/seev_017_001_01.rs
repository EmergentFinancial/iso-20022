...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.017.001.01".to_string()
}
...
pub struct SecuritiesAccount12 {
    ...
    pub bal_tp: Option<SecuritiesBalanceType6FormatChoice>,
...
pub struct ChargeType2FormatChoiceEnum {
...
pub struct ChargeType2FormatChoice {
    #[serde(flatten)]
    pub value: ChargeType2FormatChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Charges1 {
    ...
    pub tp: Option<ChargeType2FormatChoice>,
    #[validate]
    #[serde(rename = "Amt")]
...
pub struct Document {
    #[serde(rename = "AgtCAGblDstrbtnAuthstnReq")]
...
pub struct SecurityMovement1 {
    #[serde(rename = "MvmntId", skip_serializing_if = "Option::is_none")]
    pub mvmnt_id: Option<Max35Text>,
    #[serde(rename = "SctyId")]
    pub scty_id: SecurityIdentification7,
...
pub struct SecuritiesBalanceType6FormatChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct SecuritiesBalanceType6FormatChoice {
    #[serde(flatten)]
    pub value: SecuritiesBalanceType6FormatChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CashMovement1 {
    ...
    pub tax_amt: Option<ActiveCurrencyAndAmount>,
    #[validate(length(min = 0,))]
