...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.038.002.07".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "CorpActnNrrtv")]
    pub corp_actn_nrrtv: CorporateActionNarrative002V07<A>,
...
pub struct UpdatedAdditionalInformation10 {
...
pub struct CorporateActionNarrative4ChoiceEnum {
...
pub struct CorporateActionNarrative4Choice {
    #[serde(flatten)]
    pub value: CorporateActionNarrative4ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct AccountIdentification53ChoiceEnum {
    ...
    pub accts_list_and_bal_dtls: Option<AccountIdentification65>,
}
#[derive(
    Debug,
    Default,
...
pub struct AccountIdentification53Choice {
    #[serde(flatten)]
    pub value: AccountIdentification53ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CorporateActionGeneralInformation102 {
    ...
    #[serde(rename = "NrrtvTp", skip_serializing_if = "Option::is_none")]
    pub nrrtv_tp: Option<CorporateActionNarrative4Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct AccountIdentification65 {
