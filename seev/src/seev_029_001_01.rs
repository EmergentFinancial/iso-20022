...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.029.001.01".to_string()
}
...
pub struct AgentCaDeactivationCancellationRequestV01 {
    ...
    #[validate]
    #[serde(rename = "AgtCADeactvtnInstrId")]
    ...
    #[serde(rename = "DeactvtnInstrDtls", skip_serializing_if = "Option::is_none")]
    pub deactvtn_instr_dtls: Option<CorporateActionDeactivationInstruction1>,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[serde(rename = "AgtCADeactvtnCxlReq")]
