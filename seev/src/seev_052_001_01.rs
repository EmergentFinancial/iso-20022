...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.052.001.01".to_string()
}
...
pub struct RejectedReason37ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct RejectedReason37Choice {
    #[serde(flatten)]
    pub value: RejectedReason37ChoiceEnum,
}
...
pub struct PendingStatus63Choice {
    #[serde(flatten)]
    pub value: PendingStatus63ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct UnmatchedReason31ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct UnmatchedReason31Choice {
    #[serde(flatten)]
    pub value: UnmatchedReason31ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    #[serde(rename = "MktClmCreId", skip_serializing_if = "Option::is_none")]
    pub mkt_clm_cre_id: Option<DocumentIdentification9>,
    #[validate]
    #[serde(rename = "TxRef")]
    ...
    pub acct_dtls: Option<AccountIdentification46>,
    #[serde(rename = "MktClmPrcgSts")]
    pub mkt_clm_prcg_sts: MarketClaimProcessingStatus1Choice,
    #[serde(rename = "MktClmDtls", skip_serializing_if = "Option::is_none")]
    pub mkt_clm_dtls: Option<CorporateActionOption185>,
...
pub struct RejectedStatus37ChoiceEnum {
    #[serde(rename = "NoSpcfdRsn", skip_serializing_if = "Option::is_none")]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<RejectedStatusReason35>,
}
#[derive(
    Debug,
    Default,
...
pub struct RejectedStatus37Choice {
    #[serde(flatten)]
    pub value: RejectedStatus37ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CorporateActionEventType85ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct CorporateActionEventType85Choice {
    #[serde(flatten)]
    pub value: CorporateActionEventType85ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct MatchingStatus34ChoiceEnum {
...
pub struct MatchingStatus34Choice {
    #[serde(flatten)]
    pub value: MatchingStatus34ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Document<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "MktClmStsAdvc")]
    pub mkt_clm_sts_advc: MarketClaimStatusAdviceV01<A>,
...
pub struct UnmatchedStatus23ChoiceEnum {
    #[serde(rename = "Rsn", skip_serializing_if = "Option::is_none")]
    pub rsn: Option<UnmatchedReason22>,
    #[serde(rename = "NoSpcfdRsn", skip_serializing_if = "Option::is_none")]
    pub no_spcfd_rsn: Option<NoReasonCode>,
}
#[derive(
...
pub struct UnmatchedStatus23Choice {
    #[serde(flatten)]
    pub value: UnmatchedStatus23ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct MarketClaimProcessingStatus1ChoiceEnum {
...
pub struct MarketClaimProcessingStatus1Choice {
    #[serde(flatten)]
    pub value: MarketClaimProcessingStatus1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct PendingReason59ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct PendingReason59Choice {
    #[serde(flatten)]
    pub value: PendingReason59ChoiceEnum,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
