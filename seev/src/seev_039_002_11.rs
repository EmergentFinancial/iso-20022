...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.039.002.11".to_string()
}
...
pub struct AdditionalBusinessProcessFormat16ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct AdditionalBusinessProcessFormat16Choice {
    #[serde(flatten)]
    pub value: AdditionalBusinessProcessFormat16ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CorporateActionCancellation4 {
    ...
    pub cxl_rsn: Option<RestrictedFinxMax140Text>,
    #[validate]
...
pub struct CorporateActionCancellationAdvice002V11<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    ...
    pub accts_dtls: AccountIdentification50Choice,
    #[serde(rename = "CorpActnDtls", skip_serializing_if = "Option::is_none")]
    pub corp_actn_dtls: Option<CorporateAction46>,
    #[validate(length(min = 0,))]
...
> {
    ...
    pub corp_actn_cxl_advc: CorporateActionCancellationAdvice002V11<A>,
...
pub struct AccountIdentification61 {
...
pub struct AccountIdentification50ChoiceEnum {
    #[serde(rename = "AcctsList", skip_serializing_if = "Option::is_none")]
    pub accts_list: Option<AccountIdentification61>,
...
pub struct AccountIdentification50Choice {
    #[serde(flatten)]
    pub value: AccountIdentification50ChoiceEnum,
}
#[derive(
    Debug,
    Default,
