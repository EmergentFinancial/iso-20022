...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.044.001.11".to_string()
}
...
pub struct CorporateActionGeneralInformation140 {
    #[validate]
...
pub struct CorporateActionMovementPreliminaryAdviceCancellationAdviceV11<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "MvmntPrlimryAdvcId")]
    pub mvmnt_prlimry_advc_id: DocumentIdentification31,
    #[validate]
    #[serde(rename = "CorpActnGnlInf")]
    pub corp_actn_gnl_inf: CorporateActionGeneralInformation140,
    #[serde(rename = "AcctDtls")]
    pub acct_dtls: AccountIdentification49Choice,
    #[serde(rename = "CorpActnDtls", skip_serializing_if = "Option::is_none")]
    pub corp_actn_dtls: Option<CorporateAction45>,
...
pub struct Document<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "CorpActnMvmntPrlimryAdvcCxlAdvc")]
    pub corp_actn_mvmnt_prlimry_advc_cxl_advc:
        CorporateActionMovementPreliminaryAdviceCancellationAdviceV11<A>,
