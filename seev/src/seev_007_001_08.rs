...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.007.001.08".to_string()
}
...
pub struct MeetingVoteExecutionConfirmationV08<
...
> {
    ...
    #[serde(rename = "VoteInstrs", default)]
    pub vote_instrs: Vec<DetailedInstructionStatus17>,
    #[serde(
        rename = "VoteInstrsConfURLAdr",
        skip_serializing_if = "Option::is_none"
    )]
    pub vote_instrs_conf_url_adr: Option<Max2048Text>,
    #[validate(length(min = 0,))]
...
pub struct ModalityOfCounting1ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct ModalityOfCounting1Choice {
    #[serde(flatten)]
    pub value: ModalityOfCounting1ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct Vote13 {
    ...
    pub r#for: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "Agnst", skip_serializing_if = "Option::is_none")]
    pub agnst: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "Abstn", skip_serializing_if = "Option::is_none")]
    pub abstn: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "Wthhld", skip_serializing_if = "Option::is_none")]
    pub wthhld: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "WthMgmt", skip_serializing_if = "Option::is_none")]
    pub wth_mgmt: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "AgnstMgmt", skip_serializing_if = "Option::is_none")]
    pub agnst_mgmt: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "Dscrtnry", skip_serializing_if = "Option::is_none")]
    pub dscrtnry: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "OneYr", skip_serializing_if = "Option::is_none")]
    pub one_yr: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "TwoYrs", skip_serializing_if = "Option::is_none")]
    pub two_yrs: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "ThreeYrs", skip_serializing_if = "Option::is_none")]
    pub three_yrs: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "NoActn", skip_serializing_if = "Option::is_none")]
    pub no_actn: Option<FinancialInstrumentQuantity18Choice>,
    #[serde(rename = "Blnk", skip_serializing_if = "Option::is_none")]
    pub blnk: Option<FinancialInstrumentQuantity18Choice>,
    #[validate(length(min = 0, max = 4,))]
    #[serde(rename = "Prtry", default)]
    pub prtry: Vec<ProprietaryVote2>,
    #[serde(rename = "Wdrwn", skip_serializing_if = "Option::is_none")]
    pub wdrwn: Option<YesNoIndicator>,
}
#[derive(
    Debug,
    Default,
...
pub struct DetailedInstructionStatus17 {
    #[validate]
    ...
    pub prxy: Option<PartyIdentification232Choice>,
    #[serde(rename = "StgInstr", skip_serializing_if = "Option::is_none")]
    pub stg_instr: Option<YesNoIndicator>,
    #[serde(rename = "ModltyOfCntg")]
    pub modlty_of_cntg: ModalityOfCounting1Choice,
    #[serde(rename = "VoteRctDtTm", skip_serializing_if = "Option::is_none")]
    pub vote_rct_dt_tm: Option<DateAndDateTime1Choice>,
    #[validate(length(min = 0, max = 1000,))]
    #[serde(rename = "VotePerRsltn", default)]
...
> {
    #[validate]
    #[serde(rename = "MtgVoteExctnConf")]
    pub mtg_vote_exctn_conf: MeetingVoteExecutionConfirmationV08<A>,
