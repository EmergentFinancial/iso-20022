...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.033.001.12".to_string()
}
...
pub struct CorporateActionOption198 {
    #[serde(rename = "OptnNb")]
    ...
    pub frctn_dspstn: Option<FractionDispositionType28Choice>,
    ...
    pub rate_and_amt_dtls: Option<CorporateActionRate71>,
    #[serde(rename = "PricDtls", skip_serializing_if = "Option::is_none")]
    pub pric_dtls: Option<CorporateActionPrice76>,
    #[serde(rename = "ShrhldrNb", skip_serializing_if = "Option::is_none")]
    pub shrhldr_nb: Option<Max25Text>,
    #[serde(rename = "AddtlInf", skip_serializing_if = "Option::is_none")]
    pub addtl_inf: Option<CorporateActionNarrative32>,
}
#[derive(
    Debug,
    Default,
...
pub struct PriceFormat66ChoiceEnum {
...
pub struct PriceFormat66Choice {
    #[serde(flatten)]
    pub value: PriceFormat66ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct FinancialInstrumentAttributes109 {
...
pub struct CorporateActionRate71 {
    ...
    pub ovrsbcpt_rate: Option<RateAndAmountFormat39Choice>,
    #[validate(length(min = 0,))]
...
pub struct SecuritiesQuantityOrAmount6ChoiceEnum {
...
pub struct SecuritiesQuantityOrAmount6Choice {
    #[serde(flatten)]
    pub value: SecuritiesQuantityOrAmount6ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct CorporateActionPrice76 {
    ...
    pub isse_pric: Option<PriceFormat50Choice>,
    #[serde(
        rename = "GncCshPricRcvdPerPdct",
        skip_serializing_if = "Option::is_none"
    )]
    pub gnc_csh_pric_rcvd_per_pdct: Option<PriceFormat66Choice>,
    #[serde(
        rename = "GncCshPricPdPerPdct",
        skip_serializing_if = "Option::is_none"
    )]
    pub gnc_csh_pric_pd_per_pdct: Option<PriceFormat50Choice>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
...
pub struct CorporateActionBalanceDetails42 {
    ...
    pub ttl_elgbl_bal: Option<Quantity49Choice>,
    ...
    pub sttlm_pos_bal: Option<BalanceFormat11Choice>,
...
pub struct CorporateActionGeneralInformation164 {
    #[validate]
    ...
    pub undrlyg_scty: Option<FinancialInstrumentAttributes109>,
}
#[derive(
    Debug,
    Default,
...
> {
    ...
    pub corp_actn_instr: CorporateActionInstructionV12<A>,
...
pub struct CorporateActionInstructionV12<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    ...
    pub canc_instr_id: Option<DocumentIdentification31>,
    #[serde(rename = "InstrCxlReqId", skip_serializing_if = "Option::is_none")]
    pub instr_cxl_req_id: Option<DocumentIdentification31>,
    #[validate(length(min = 0,))]
    ...
    pub corp_actn_gnl_inf: CorporateActionGeneralInformation164,
    #[validate]
    #[serde(rename = "AcctDtls")]
    pub acct_dtls: AccountAndBalance48,
    #[validate(length(min = 0,))]
    #[serde(rename = "BnfclOwnrDtls", default)]
    pub bnfcl_ownr_dtls: Vec<PartyIdentification251>,
    #[validate]
    #[serde(rename = "CorpActnInstr")]
    pub corp_actn_instr: CorporateActionOption198,
    #[serde(rename = "PrtctInstr", skip_serializing_if = "Option::is_none")]
    pub prtct_instr: Option<ProtectInstruction1>,
    #[serde(rename = "AddtlInf", skip_serializing_if = "Option::is_none")]
    pub addtl_inf: Option<CorporateActionNarrative30>,
    #[validate(length(min = 0,))]
...
pub struct BeneficiaryCertificationType10ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct BeneficiaryCertificationType10Choice {
    #[serde(flatten)]
    pub value: BeneficiaryCertificationType10ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct ProtectInstruction1 {
    ...
    pub prtct_sfkpg_acct: Option<Max35Text>,
...
pub struct CorporateActionChangeTypeFormat6ChoiceEnum {
    #[serde(rename = "Prtry", skip_serializing_if = "Option::is_none")]
    pub prtry: Option<GenericIdentification30>,
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct CorporateActionChangeTypeFormat6Choice {
    #[serde(flatten)]
    pub value: CorporateActionChangeTypeFormat6ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct AccountAndBalance48 {
    ...
    #[serde(rename = "Bal", skip_serializing_if = "Option::is_none")]
    pub bal: Option<CorporateActionBalanceDetails42>,
}
#[derive(
    Debug,
    Default,
...
pub struct PartyIdentification251 {
    #[serde(rename = "OwnrId")]
    ...
    pub whldg_tax_rate: Option<RateAndAmountFormat37Choice>,
    #[validate(length(min = 0,))]
    #[serde(rename = "CertfctnBrkdwn", default)]
    pub certfctn_brkdwn: Vec<Max350Text>,
}
...
pub struct PartyIdentification229ChoiceEnum {
...
pub struct PartyIdentification229Choice {
    #[serde(flatten)]
    pub value: PartyIdentification229ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
pub struct SecuritiesOption79 {
    ...
    pub addtl_rnd_up_qty: Option<FinancialInstrumentQuantity33Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct FractionDispositionType28ChoiceEnum {
    #[serde(rename = "Cd", skip_serializing_if = "Option::is_none")]
...
pub struct FractionDispositionType28Choice {
    #[serde(flatten)]
    pub value: FractionDispositionType28ChoiceEnum,
}
#[derive(
    Debug,
    Default,
