...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.003.001.08".to_string()
}
...
pub struct OrganisationIdentification5 {
    ...
    #[serde(rename = "RegrNm", skip_serializing_if = "Option::is_none")]
    pub regr_nm: Option<Max35Text>,
}
...
pub struct PartyIdentification249 {
    #[serde(rename = "Id")]
    pub id: PartyIdentification237Choice,
    #[serde(rename = "AddtlIdInf", skip_serializing_if = "Option::is_none")]
    pub addtl_id_inf: Option<PartyAdditionalIdentification2Choice>,
}
#[derive(
    Debug,
    Default,
...
pub struct MeetingEntitlementNotificationV08<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[serde(rename = "NtfctnTp")]
    pub ntfctn_tp: NotificationType2Code,
    #[serde(
        rename = "PrvsEntitlmntNtfctnId",
        skip_serializing_if = "Option::is_none"
    )]
    pub prvs_entitlmnt_ntfctn_id: Option<Max35Text>,
    #[validate]
    #[serde(rename = "MtgRef")]
    ...
    pub scty: Vec<SecurityPosition14>,
    #[validate]
    #[serde(rename = "Elgblty")]
    pub elgblty: EligibilityDates1,
    #[serde(rename = "MtgAttndee", skip_serializing_if = "Option::is_none")]
    pub mtg_attndee: Option<PartyIdentification232Choice>,
...
pub struct PartyAdditionalIdentification2ChoiceEnum {
...
pub struct PartyAdditionalIdentification2Choice {
    #[serde(flatten)]
    pub value: PartyAdditionalIdentification2ChoiceEnum,
}
#[derive(
    Debug,
    Default,
...
> {
    #[validate]
    #[serde(rename = "MtgEntitlmntNtfctn")]
    pub mtg_entitlmnt_ntfctn: MeetingEntitlementNotificationV08<A>,
...
pub struct EligiblePosition11 {
    #[validate]
    #[serde(rename = "AcctId")]
    pub acct_id: Max35Text,
    #[serde(rename = "AcctOwnr", skip_serializing_if = "Option::is_none")]
    pub acct_ownr: Option<PartyIdentification241>,
    ...
    pub rghts_hldr: Vec<PartyIdentification249>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
