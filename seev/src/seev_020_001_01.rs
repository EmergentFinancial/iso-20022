...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:seev.020.001.01".to_string()
}
...
pub struct AgentCaMovementCancellationRequestV01 {
    ...
    #[validate]
    #[serde(rename = "AgtCAMvmntInstrId")]
    ...
    pub mvmnt_dtls: Option<MovementInstruction1>,
}
#[derive(
    Debug,
    Default,
...
pub struct MovementInstruction1 {
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "PrcdsMvmntDtls", default)]
