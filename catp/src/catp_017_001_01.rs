...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:catp.017.001.01".to_string()
}
...
pub struct CardAccount13 {
    ...
    #[serde(rename = "BalBfr", skip_serializing_if = "Option::is_none")]
    pub bal_bfr: Option<AmountAndDirection43>,
    #[serde(rename = "BalAftr", skip_serializing_if = "Option::is_none")]
    pub bal_aftr: Option<AmountAndDirection43>,
}
#[derive(
    Debug,
    Default,
...
pub struct DetailedAmount18 {
    ...
    #[serde(rename = "Ccy", skip_serializing_if = "Option::is_none")]
    pub ccy: Option<ActiveCurrencyCode>,
    #[serde(rename = "ChrgAcctTo", skip_serializing_if = "Option::is_none")]
    pub chrg_acct_to: Option<TrueFalseIndicator>,
...
pub struct AtmTransaction24 {
    ...
    #[serde(rename = "CdtrLabl", skip_serializing_if = "Option::is_none")]
    pub cdtr_labl: Option<Max35Text>,
    #[serde(rename = "DbtrLabl", skip_serializing_if = "Option::is_none")]
    pub dbtr_labl: Option<Max35Text>,
    #[serde(rename = "TrfIdr", skip_serializing_if = "Option::is_none")]
    pub trf_idr: Option<Max70Text>,
    #[serde(rename = "PmtRef", skip_serializing_if = "Option::is_none")]
    pub pmt_ref: Option<Max35Text>,
    #[validate]
    #[serde(rename = "TxRspn")]
    ...
    pub acct_fr: Option<CardAccount13>,
    #[serde(rename = "PrtctdAcctFr", skip_serializing_if = "Option::is_none")]
    pub prtctd_acct_fr: Option<ContentInformationType10>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AcctTo", default)]
    pub acct_to: Vec<CardAccount13>,
    #[serde(rename = "PrtctdAcctTo", skip_serializing_if = "Option::is_none")]
    pub prtctd_acct_to: Option<ContentInformationType10>,
    #[validate]
    ...
    pub dtld_reqd_amt: Option<DetailedAmount17>,
    #[validate(length(min = 0,))]
    #[serde(rename = "AddtlChrg", default)]
    pub addtl_chrg: Vec<DetailedAmount18>,
    #[serde(rename = "Lmts", skip_serializing_if = "Option::is_none")]
    pub lmts: Option<AtmTransactionAmounts6>,
    #[serde(rename = "ReqdExctnDt", skip_serializing_if = "Option::is_none")]
    pub reqd_exctn_dt: Option<IsoDate>,
    #[serde(rename = "PropsdExctnDt", skip_serializing_if = "Option::is_none")]
    pub propsd_exctn_dt: Option<IsoDate>,
    #[serde(rename = "InstntTrfPrgm", skip_serializing_if = "Option::is_none")]
    pub instnt_trf_prgm: Option<Max35Text>,
    #[serde(rename = "RcrngTrf", skip_serializing_if = "Option::is_none")]
    pub rcrng_trf: Option<RecurringTransaction3>,
...
pub struct AtmTransferResponseV01 {
    ...
    #[serde(rename = "Hdr")]
    pub hdr: Header31,
    #[serde(rename = "PrtctdATMTrfRspn", skip_serializing_if = "Option::is_none")]
    pub prtctd_atm_trf_rspn: Option<ContentInformationType10>,
    #[serde(rename = "ATMTrfRspn", skip_serializing_if = "Option::is_none")]
    pub atm_trf_rspn: Option<AtmTransferResponse1>,
...
pub struct RecurringTransaction3 {
    ...
    #[serde(rename = "NbOfOcrncs", skip_serializing_if = "Option::is_none")]
    pub nb_of_ocrncs: Option<Number>,
    #[validate]
    #[serde(rename = "EndDt")]
    pub end_dt: IsoDate,
    #[serde(rename = "PrdUnit", skip_serializing_if = "Option::is_none")]
    pub prd_unit: Option<Frequency3Code>,
    #[serde(rename = "IntrvlDay", skip_serializing_if = "Option::is_none")]
    pub intrvl_day: Option<Number>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
