...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:catp.002.001.02".to_string()
}
...
pub struct AtmTransaction14 {
    ...
    pub ccy_convs_elgblty: Option<CurrencyConversion9>,
    #[validate(length(min = 0,))]
...
pub struct AtmWithdrawalResponseV02 {
    ...
    #[serde(rename = "Hdr")]
    pub hdr: Header31,
    #[serde(rename = "PrtctdATMWdrwlRspn", skip_serializing_if = "Option::is_none")]
    pub prtctd_atm_wdrwl_rspn: Option<ContentInformationType10>,
    #[serde(rename = "ATMWdrwlRspn", skip_serializing_if = "Option::is_none")]
    pub atm_wdrwl_rspn: Option<AtmWithdrawalResponse2>,
