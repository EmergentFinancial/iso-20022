...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caaa.014.001.09".to_string()
}
...
pub struct Document {
    #[validate]
    #[serde(rename = "AccptrDgnstcRspn")]
    pub accptr_dgnstc_rspn: AcceptorDiagnosticResponseV09,
...
pub struct AcceptorDiagnosticResponseV09 {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header59,
    #[validate]
    #[serde(rename = "DgnstcRspn")]
    pub dgnstc_rspn: AcceptorDiagnosticResponse8,
...
pub struct AcceptorDiagnosticResponse8 {
    #[validate]
    #[serde(rename = "Envt")]
    ...
    #[serde(rename = "AcqrrAvlbl", skip_serializing_if = "Option::is_none")]
    pub acqrr_avlbl: Option<TrueFalseIndicator>,
}
#[derive(
    Debug,
    Default,
