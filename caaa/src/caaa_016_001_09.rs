...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caaa.016.001.09".to_string()
}
...
pub struct AcceptorCurrencyConversionRequestV09 {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header59,
    #[validate]
    #[serde(rename = "CcyConvsReq")]
    pub ccy_convs_req: AcceptorCurrencyConversionRequest9,
...
pub struct AcceptorCurrencyConversionRequest9 {
    #[validate]
    #[serde(rename = "Envt")]
    pub envt: CardPaymentEnvironment78,
    #[validate]
    #[serde(rename = "Tx")]
    pub tx: CardPaymentTransaction120,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[validate]
    #[serde(rename = "AccptrCcyConvsReq")]
    pub accptr_ccy_convs_req: AcceptorCurrencyConversionRequestV09,
