...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caaa.012.001.10".to_string()
}
...
pub struct CardPaymentDataSet31 {
    #[validate]
    #[serde(rename = "DataSetId")]
    pub data_set_id: DataSetIdentification5,
    #[validate]
    #[serde(rename = "DataSetRslt")]
    pub data_set_rslt: ResponseType10,
    #[validate]
    #[serde(rename = "RmvDataSet")]
    ...
    #[validate(length(min = 0,))]
    #[serde(rename = "RjctdTx", default)]
    pub rjctd_tx: Vec<CardPaymentDataSet30>,
    #[validate(length(min = 0,))]
    #[serde(rename = "SspdTx", default)]
    pub sspd_tx: Vec<CardPaymentDataSet30>,
    #[validate(length(min = 0,))]
    #[serde(rename = "RsmdApprvl", default)]
    pub rsmd_apprvl: Vec<CardPaymentDataSet30>,
    #[validate(length(min = 0,))]
    #[serde(rename = "RsmdRjctn", default)]
    pub rsmd_rjctn: Vec<CardPaymentDataSet30>,
}
#[derive(
    Debug,
    Default,
...
pub struct CardPaymentDataSet30 {
    #[validate]
...
pub struct AcceptorBatchTransferResponseV10 {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header56,
    #[validate]
    #[serde(rename = "BtchTrfRspn")]
    pub btch_trf_rspn: CardPaymentBatchTransferResponse9,
...
pub struct CardPaymentBatchTransferResponse9 {
    #[validate(length(min = 0,))]
    #[serde(rename = "TxTtls", default)]
    pub tx_ttls: Vec<TransactionTotals12>,
    #[validate(length(min = 0,))]
    #[serde(rename = "DataSet", default)]
    pub data_set: Vec<CardPaymentDataSet31>,
}
#[derive(
    Debug,
    Default,
...
pub struct Document {
    #[validate]
    #[serde(rename = "AccptrBtchTrfRspn")]
    pub accptr_btch_trf_rspn: AcceptorBatchTransferResponseV10,
