...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caaa.017.001.09".to_string()
}
...
pub struct AcceptorCurrencyConversionResponseV09 {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header59,
    #[validate]
    #[serde(rename = "CcyConvsRspn")]
    pub ccy_convs_rspn: AcceptorCurrencyConversionResponse9,
...
pub struct Document {
    #[validate]
    #[serde(rename = "AccptrCcyConvsRspn")]
    pub accptr_ccy_convs_rspn: AcceptorCurrencyConversionResponseV09,
...
pub struct AcceptorCurrencyConversionResponse9 {
    #[validate]
    #[serde(rename = "Envt")]
    ...
    #[validate]
    #[serde(rename = "CcyConvsRslt")]
    pub ccy_convs_rslt: CurrencyConversion25,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize)]
