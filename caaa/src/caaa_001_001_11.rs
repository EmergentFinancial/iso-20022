...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caaa.001.001.11".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "AccptrAuthstnReq")]
    pub accptr_authstn_req: AcceptorAuthorisationRequestV11<A>,
...
pub struct AcceptorAuthorisationRequestV11<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header59,
    #[validate]
    #[serde(rename = "AuthstnReq")]
    pub authstn_req: AcceptorAuthorisationRequest11<A>,
...
pub struct AcceptorAuthorisationRequest11<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Envt")]
