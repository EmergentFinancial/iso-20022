...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:caaa.021.001.03".to_string()
}
...
> {
    #[serde(rename = "TxAdvcRspn")]
    pub tx_advc_rspn: TransactionAdviceResponseV03<A>,
...
pub struct TransactionAdviceResponseV03<
    A: std::fmt::Debug + Default + Clone + PartialEq + ::serde::Serialize + ::validator::Validate,
> {
    #[validate]
    #[serde(rename = "Hdr")]
    pub hdr: Header59,
    #[serde(rename = "TxAdvcRspn")]
    pub tx_advc_rspn: AcceptorCompletionAdviceResponse10<A>,
