...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsin.005.001.01".to_string()
}
...
> {
    #[validate]
    #[serde(rename = "UdrtkgAppl")]
    pub udrtkg_appl: UndertakingApplicationV01<A, B>,
...
pub struct ExpiryDetails2 {
    ...
    pub xpry_terms: Option<ExpiryTerms2>,
...
pub struct Document11 {
    ...
    pub tp: Option<PresentationDocumentFormat1Choice>,
...
> {
    ...
    #[serde(rename = "Cnfrmr", skip_serializing_if = "Option::is_none")]
    pub cnfrmr: Option<PartyIdentification43>,
    #[serde(rename = "ConfInd", skip_serializing_if = "Option::is_none")]
    pub conf_ind: Option<YesNoIndicator>,
    #[validate]
    #[serde(rename = "CntrUdrtkgInd")]
    pub cntr_udrtkg_ind: YesNoIndicator,
    #[serde(rename = "CntrUdrtkg", skip_serializing_if = "Option::is_none")]
    pub cntr_udrtkg: Option<Undertaking2>,
    #[validate]
    ...
    pub presntn_dtls: Option<Presentation4>,
    #[validate]
    ...
    #[validate]
    #[serde(rename = "DlvryChanl")]
    pub dlvry_chanl: CommunicationChannel1,
    #[serde(rename = "OblgrLbltyAcct", skip_serializing_if = "Option::is_none")]
    pub oblgr_lblty_acct: Option<CashAccount28>,
    #[serde(rename = "OblgrChrgAcct", skip_serializing_if = "Option::is_none")]
    pub oblgr_chrg_acct: Option<CashAccount28>,
    #[serde(rename = "OblgrSttlmAcct", skip_serializing_if = "Option::is_none")]
    pub oblgr_sttlm_acct: Option<CashAccount28>,
    #[validate(length(min = 0,))]
    #[serde(rename = "NclsdFile", default)]
    pub nclsd_file: Vec<Document9<A>>,
    #[validate(length(min = 0, max = 5,))]
    #[serde(rename = "AddtlApplInf", default)]
...
pub struct Undertaking2 {
    #[serde(rename = "Nm", skip_serializing_if = "Option::is_none")]
    pub nm: Option<UndertakingName1Code>,
    #[serde(rename = "Bnfcry", skip_serializing_if = "Option::is_none")]
    pub bnfcry: Option<PartyIdentification43>,
    #[serde(rename = "XpryDtls", skip_serializing_if = "Option::is_none")]
    pub xpry_dtls: Option<ExpiryDetails2>,
    #[serde(rename = "CntrUdrtkgAmt", skip_serializing_if = "Option::is_none")]
    pub cntr_udrtkg_amt: Option<UndertakingAmount1>,
    #[serde(rename = "ConfChrgsPyblBy", skip_serializing_if = "Option::is_none")]
    pub conf_chrgs_pybl_by: Option<ExternalTypeOfParty1Code>,
    #[serde(rename = "GovncRulesAndLaw", skip_serializing_if = "Option::is_none")]
    pub govnc_rules_and_law: Option<GovernanceRules1>,
    #[serde(rename = "StdClmDocInd", skip_serializing_if = "Option::is_none")]
    pub std_clm_doc_ind: Option<YesNoIndicator>,
    #[validate(length(min = 0, max = 5,))]
    #[serde(rename = "AddtlInf", default)]
    pub addtl_inf: Vec<Max2000Text>,
}
...
> {
    #[validate]
    #[serde(rename = "UdrtkgApplDtls")]
    pub udrtkg_appl_dtls: Undertaking1<A>,
    #[validate(length(min = 0, max = 5,))]
    #[serde(rename = "InstrsToBk", default)]
