...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01".to_string()
}
...
> {
    ...
    #[validate(length(min = 1,))]
    #[serde(rename = "PmtStsList", default)]
    pub pmt_sts_list: Vec<FinancingItemList1<B>>,
    #[serde(rename = "PmtStsCnt", skip_serializing_if = "Option::is_none")]
    pub pmt_sts_cnt: Option<Max15NumericText>,
...
> {
    #[validate]
    #[serde(rename = "InvcAssgnmtAck")]
    pub invc_assgnmt_ack: InvoiceAssignmentAcknowledgementV01<A, B, C, D>,
